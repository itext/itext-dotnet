/*
$Id: a698a08df5c2818ca012089560d2a2c1b8e09b29 $
...
namespace com.itextpdf.barcodes
{
	...
	public class BarcodeInter25 : Barcode1D
	{
		...
		private static readonly byte[][] BARS = new byte[][] { new byte[] { 0, 0, 1, 1, 0
			 }, new byte[] { 1, 0, 0, 0, 1 }, new byte[] { 0, 1, 0, 0, 1 }, new byte[] { 1, 
			1, 0, 0, 0 }, new byte[] { 0, 0, 1, 0, 1 }, new byte[] { 1, 0, 1, 0, 0 }, new byte
			[] { 0, 1, 1, 0, 0 }, new byte[] { 0, 0, 0, 1, 1 }, new byte[] { 1, 0, 0, 1, 0 }
			, new byte[] { 0, 1, 0, 1, 0 } };
