...
namespace iTextSharp.Layout.Renderer
{
    ...
    public class AccessibleAttributesApplier
    {
             ...
             attributes)
        {
            ...
            iTextSharp.Kernel.Color.Color color = renderer.GetPropertyAsColor(iTextSharp.Layout.Property.Property
                .FONT_COLOR);
             ...
             renderer, PdfDictionary attributes, PdfDocument doc)
        {
            float?[] margins = new float?[] { renderer.GetPropertyAsFloat(iTextSharp.Layout.Property.Property
                .MARGIN_TOP), renderer.GetPropertyAsFloat(iTextSharp.Layout.Property.Property
                .MARGIN_BOTTOM), renderer.GetPropertyAsFloat(iTextSharp.Layout.Property.Property
                .MARGIN_LEFT), renderer.GetPropertyAsFloat(iTextSharp.Layout.Property.Property
                .MARGIN_RIGHT) };
             ...
             attributes)
        {
            ...
            if (underlines != null)
            {
                ...
                if (underlines is IList && !((IList<Object>)underlines).IsEmpty() && ((IList)underlines
                    )[0] is Underline)
                {
             ...
             attributes)
        {
            ...
            if (specificBorderProperties)
            {
                ...
                iTextSharp.Layout.Border.Border[] borders = renderer.GetBorders();
