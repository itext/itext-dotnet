...
namespace iTextSharp.Forms
{
	public class PdfFormCopyTest : ExtendedITextTest
	{
		...
		public virtual void CopyFieldsTest01()
		{
			...
			PdfDocument doc1 = new PdfDocument(new PdfReader(new FileStream(srcFilename1)));
			PdfDocument doc2 = new PdfDocument(new PdfReader(new FileStream(srcFilename2)));
			PdfDocument doc3 = new PdfDocument(new PdfReader(new FileStream(srcFilename3)));
		...
		public virtual void CopyFieldsTest02()
		{
			...
			PdfDocument doc1 = new PdfDocument(new PdfReader(new FileStream(srcFilename)));
			PdfDocument pdfDoc = new PdfDocument(new PdfWriter(new FileOutputStream(filename)
				));
			pdfDoc.InitializeOutlines();
			doc1.CopyPagesTo(1, doc1.GetNumberOfPages(), pdfDoc, new PdfPageFormCopier());
		...
		public virtual void CopyFieldsTest04()
		{
			...
			PdfDocument srcDoc = new PdfDocument(new PdfReader(new FileStream(srcFilename)));
		...
		public virtual void CopyPagesWithInheritedResources()
		{
			...
			PdfReader reader = new PdfReader(new FileStream(sourceFile));
