/*
$Id: fccd0d6f8ba94883269fc04710b6d06ac508d0a6 $
...
namespace com.itextpdf.signatures
{
	...
	public class ProviderDigest : IExternalDigest
	{
		private String provider;

		/// <summary>Creates a ProviderDigest.</summary>
		/// <param name="provider">String name of the provider that you want to use to create the hash
		/// 	</param>
