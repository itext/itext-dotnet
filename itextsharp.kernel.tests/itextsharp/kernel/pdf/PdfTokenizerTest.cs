	...
	public class PdfTokenizerTest
	{
		...
		public virtual void TestTwoNumbers()
		{
			CheckTokenTypes("/Name1 70/Name 2", PdfTokenizer.TokenType.Name, PdfTokenizer.TokenType
				.Number, PdfTokenizer.TokenType.Name, PdfTokenizer.TokenType.Number, PdfTokenizer.TokenType
				.EndOfFile);
		}
		...
		public virtual void TokenTypesTest()
		{
			CheckTokenTypes("<</Size 70/Root 46 0 R/Info 44 0 R/ID[<8C2547D58D4BD2C6F3D32B830BE3259D><8F69587888569A458EB681A4285D5879>]/Prev 116 >>"
				, PdfTokenizer.TokenType.StartDic, PdfTokenizer.TokenType.Name, PdfTokenizer.TokenType
				.Number, PdfTokenizer.TokenType.Name, PdfTokenizer.TokenType.Ref, PdfTokenizer.TokenType
				.Name, PdfTokenizer.TokenType.Ref, PdfTokenizer.TokenType.Name, PdfTokenizer.TokenType
				.StartArray, PdfTokenizer.TokenType.String, PdfTokenizer.TokenType.String, PdfTokenizer.TokenType
				.EndArray, PdfTokenizer.TokenType.Name, PdfTokenizer.TokenType.Number, PdfTokenizer.TokenType
		...
		public virtual void EncodingTest()
		{
			...
			tok = new PdfTokenizer(new RandomAccessFileOrArray(factory.CreateSource(testHexString
				.GetBytes())));
			tok.NextToken();
			...
			NUnit.Framework.Assert.AreEqual("This string contains \u00A5two octal characters\u00C7"
				, pdfString.GetValue());
			...
			NUnit.Framework.Assert.AreEqual(iTextSharp.IO.Util.JavaUtil.GetStringForBytes(b), 
				pdfString.GetValue());
		}
