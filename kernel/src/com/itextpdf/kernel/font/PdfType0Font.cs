...
namespace com.itextpdf.kernel.font
{
	public class PdfType0Font : PdfFont
	{
		...
		private static readonly byte[] rotbits = new byte[] { unchecked((byte)0x80), unchecked(
			(byte)0x40), unchecked((byte)0x20), unchecked((byte)0x10), unchecked((byte)0x08)
			, unchecked((byte)0x04), unchecked((byte)0x02), unchecked((byte)0x01) };
