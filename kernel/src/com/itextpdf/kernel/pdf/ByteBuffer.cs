/*
* $Id: f5790c385da820fd869c79765f91353073f189be $
*
...
namespace com.itextpdf.kernel.pdf
{
	...
	public class ByteBuffer : Stream
	{
		...
		/// <summary>Creates new ByteBuffer with capacity 128</summary>
		public ByteBuffer()
			: this(128)
		{
		}
		...
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append_i(int b)
		{
		...
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(byte[] b, int off, int len
			)
		{
		...
		/// <param name="b">the array to be appended</param>
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(byte[] b)
		{
		...
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(String str)
		{
			if (str != null)
			{
		...
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(char c)
		{
			return Append_i(c);
		}

		/// <summary>Appends another <CODE>ByteBuffer</CODE> to this buffer.</summary>
		/// <param name="buf">the <CODE>ByteBuffer</CODE> to be appended</param>
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(com.itextpdf.kernel.pdf.ByteBuffer
			 buf)
		{
		...
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(int i)
		{
		...
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(long i)
		{
		...
		public virtual com.itextpdf.kernel.pdf.ByteBuffer AppendHex(byte b)
		{
		...
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(float i)
		{
			return Append((double)i);
		}
		...
		/// <returns>a reference to this <CODE>ByteBuffer</CODE> object</returns>
		public virtual com.itextpdf.kernel.pdf.ByteBuffer Append(double d)
		{
		...
		/// </returns>
		public static String FormatDouble(double d, com.itextpdf.kernel.pdf.ByteBuffer buf
			)
		{
			if (HIGH_PRECISION)
			{
		...
		{
			return com.itextpdf.io.util.JavaUtil.GetStringForBytes(buf, 0, count);
		}
		...
		{
			return com.itextpdf.io.util.JavaUtil.GetStringForBytes(buf, 0, count, enc);
		}
