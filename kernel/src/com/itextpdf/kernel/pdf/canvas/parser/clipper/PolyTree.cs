/*
* $Id: 0140edc11ae9f6dc9b9a672699439918b0fc996f $
*
...
namespace com.itextpdf.kernel.pdf.canvas.parser.clipper
{
	...
	{
		private readonly IList<PolyNode> allPolys = new List<PolyNode>();
		...
		public virtual IList<PolyNode> GetAllPolys()
		{
			return allPolys;
		}

		public virtual PolyNode GetFirst()
		{
			if (!childs.IsEmpty())
			{
				return childs[0];
