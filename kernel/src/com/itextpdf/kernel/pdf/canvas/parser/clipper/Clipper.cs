/*
* $Id: 1385068b87a7086893dbb71c4164cc6c23fbb1f1 $
*
...
namespace com.itextpdf.kernel.pdf.canvas.parser.clipper
{
	public abstract class Clipper
	{
		...
		public abstract bool AddPath(Path pg, Clipper.PolyType polyType, bool Closed);

		public abstract bool AddPaths(Paths ppg, Clipper.PolyType polyType, bool closed);

		public abstract void Clear();

		public abstract bool Execute(Clipper.ClipType clipType, Paths solution);

		public abstract bool Execute(Clipper.ClipType clipType, Paths solution, Clipper.PolyFillType
			 subjFillType, Clipper.PolyFillType clipFillType);

		public abstract bool Execute(Clipper.ClipType clipType, PolyTree polytree);

		public abstract bool Execute(Clipper.ClipType clipType, PolyTree polytree, Clipper.PolyFillType
			 subjFillType, Clipper.PolyFillType clipFillType);
	}

	public static class ClipperConstants
	{
	}
}
