...
namespace com.itextpdf.kernel.crypto.securityhandler
{
	public class StandardHandlerUsingStandard40 : StandardSecurityHandler
	{
		protected internal static readonly byte[] pad = new byte[] { unchecked((byte)0x28
			...
			(byte)0x4E), unchecked((byte)0x75), unchecked((byte)0x8A), unchecked((byte)0x41)
			, unchecked((byte)0x64), unchecked((byte)0x00), unchecked((byte)0x4E), unchecked(
			(byte)0x56), unchecked((byte)0xFF), unchecked((byte)0xFA), unchecked((byte)0x01)
			, unchecked((byte)0x08), unchecked((byte)0x2E), unchecked((byte)0x2E), unchecked(
			(byte)0x00), unchecked((byte)0xB6), unchecked((byte)0xD0), unchecked((byte)0x68)
			, unchecked((byte)0x3E), unchecked((byte)0x80), unchecked((byte)0x2F), unchecked(
			(byte)0x0C), unchecked((byte)0xA9), unchecked((byte)0xFE), unchecked((byte)0x64)
			, unchecked((byte)0x53), unchecked((byte)0x69), unchecked((byte)0x7A) };
