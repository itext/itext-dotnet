...
;
        ...
        public virtual void DefaultProcessingTestPassedPropertiesReturnNullValues() {
            ...
            //Run
            DefaultSvgProcessor processor = new DefaultSvgProcessor();
            ISvgConverterProperties convProps = new _ISvgConverterProperties_250();
        ...
        private sealed class _ISvgConverterProperties_250 : ISvgConverterProperties {
            public _ISvgConverterProperties_250() {
            }
