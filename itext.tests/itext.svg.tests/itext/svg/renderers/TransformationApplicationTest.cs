...
namespace iText.Svg.Renderers {
    public class TransformationApplicationTest {
        ...
        public virtual void NormalDrawTest() {
            ...
            ISvgNodeRenderer nodeRenderer = new _AbstractSvgNodeRenderer_26();
            // do nothing
        ...
        private sealed class _AbstractSvgNodeRenderer_26 : AbstractSvgNodeRenderer {
            public _AbstractSvgNodeRenderer_26() {
            }
