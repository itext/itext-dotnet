...
namespace iTextSharp.Layout {
    public class OverflowTest : ExtendedITextTest {
        ...
        public virtual void TextOverflowTest02() {
            ...
            PdfDocument pdfDocument = new PdfDocument(new PdfWriter(new FileStream(outFileName, FileMode.Create)));
            Document document = new Document(pdfDocument);
            iTextSharp.Layout.Element.Text overflowText = new iTextSharp.Layout.Element.Text("This is a long-long and large text which will not overflow"
                ).SetFontSize(19).SetFontColor(iTextSharp.Kernel.Color.Color.RED);
        ...
        public virtual void TextOverflowTest03() {
            ...
            PdfDocument pdfDocument = new PdfDocument(new PdfWriter(new FileStream(outFileName, FileMode.Create)));
            Document document = new Document(pdfDocument);
            iTextSharp.Layout.Element.Text overflowText = new iTextSharp.Layout.Element.Text("This is a long-long and large text which will overflow"
                ).SetFontSize(25).SetFontColor(iTextSharp.Kernel.Color.Color.RED);
