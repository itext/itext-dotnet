...
namespace iText.Layout {
    public class TableTest : ExtendedITextTest {
        ...
        public virtual void TableWithCustomRendererTest01() {
            ...
            table.SetNextRenderer(new _T1202019622(this, table, new Table.RowRange(0, 10)));
            doc.Add(table);
            doc.Close();
            NUnit.Framework.Assert.IsNull(new CompareTool().CompareByContent(outFileName, cmpFileName, destinationFolder
                , testName + "_diff"));
        ...
        internal class _T1202019622 : TableRenderer {
            public _T1202019622(TableTest _enclosing, Table modelElement, Table.RowRange rowRange)
