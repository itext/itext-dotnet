...
namespace iText.Layout.Font {
    ...
    public class RangeTest : ExtendedITextTest {
        ...
        public virtual void TestHashCodeAndEquals() {
            iText.Layout.Font.Range range = new RangeBuilder((char)25, (char)26).AddRange(1, 5).AddRange(4, 7).Create(
                );
            iText.Layout.Font.Range range2 = new RangeBuilder(25, 26).AddRange((char)1, (char)7).Create();
            ...
            iText.Layout.Font.Range range3 = new RangeBuilder(25).AddRange((char)26).AddRange((char)1, (char)7).Create
                ();
            ...
            iText.Layout.Font.Range range4 = new RangeBuilder(26).AddRange((char)25).AddRange((char)1, (char)4).AddRange
                ((char)3, (char)7).Create();
        ...
        public virtual void TestUnionAndContains() {
            iText.Layout.Font.Range range = new RangeBuilder((char)25, (char)27).AddRange(2, 10).AddRange(0, 20).AddRange
                (1, 19).AddRange(33, 40).AddRange(0, 5).AddRange(20, 22).AddRange(8, 15).AddRange(25, 30).Create();
        ...
        public virtual void TestSingles() {
            iText.Layout.Font.Range range = new RangeBuilder((char)1).AddRange(2).AddRange(3).AddRange(6).Create();
