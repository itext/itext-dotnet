...
namespace iText.Events.Utils {
    ...
    public class StringUtilTest : ExtendedITextTest {
        ...
        public virtual void PatternSplitTest01() {
            ...
            Regex pattern = iText.Events.Utils.StringUtil.RegexCompile("(?=[ab])");
            String source = "a01aa78ab89b";
            String[] expected = new String[] { "a01", "a", "a78", "a", "b89", "b" };
            String[] result = iText.Events.Utils.StringUtil.Split(pattern, source);
        ...
        public virtual void StringSplitTest01() {
            String source = "a01aa78ab89b";
            String[] expected = new String[] { "a01", "a", "a78", "a", "b89", "b" };
            String[] result = iText.Events.Utils.StringUtil.Split(source, "(?=[ab])");
            NUnit.Framework.Assert.AreEqual(expected, result);
        }
