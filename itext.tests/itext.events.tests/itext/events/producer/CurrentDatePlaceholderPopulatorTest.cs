...
namespace iText.Events.Producer {
    public class CurrentDatePlaceholderPopulatorTest : ExtendedITextTest {
        ...
        public virtual void NullTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(MessageFormatUtil.Format(EventsExceptionMessageConstant.INVALID_USAGE_FORMAT_REQUIRED, "currentDate")))
;
        }
        ...
        public virtual void PlainTextEndlessQuotationErrorTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(EventsExceptionMessageConstant.PATTERN_CONTAINS_OPEN_QUOTATION))
;
        }
...
;
        ...
        public virtual void UnexpectedLetterComponentTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(MessageFormatUtil.Format(EventsExceptionMessageConstant.PATTERN_CONTAINS_UNEXPECTED_COMPONENT, "t")))
;
        }
        ...
        public virtual void UnexpectedLongComponentTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(MessageFormatUtil.Format(EventsExceptionMessageConstant.PATTERN_CONTAINS_UNEXPECTED_COMPONENT, "MMMMM")))
;
        }
        ...
        public virtual void UnexpectedShortComponentTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(MessageFormatUtil.Format(EventsExceptionMessageConstant.PATTERN_CONTAINS_UNEXPECTED_COMPONENT, "y")))
;
        }
    }
}
