...
;
        ...
        public virtual void InvalidLetterFormatTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(MessageFormatUtil.Format(EventsExceptionMessageConstant.PATTERN_CONTAINS_UNEXPECTED_CHARACTER, "X")))
;
        }
