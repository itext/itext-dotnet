...
namespace iText.Events.Producer {
    public class ProducerBuilderTest : ExtendedITextTest {
        ...
        public virtual void EmptyEventsProducerLineTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(EventsExceptionMessageConstant.NO_EVENTS_WERE_REGISTERED_FOR_THE_DOCUMENT))
;
        }
...
;
        ...
        public virtual void UsedProductsEmptyFormatProducerLineTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(MessageFormatUtil.Format(EventsExceptionMessageConstant.INVALID_USAGE_FORMAT_REQUIRED, "usedProducts")))
;
        }

        [NUnit.Framework.Test]
        [LogMessage(EventsLogMessageConstant.UNKNOWN_PLACEHOLDER_WAS_IGNORED, Count = 3, LogLevel = LogLevelConstants
            .INFO)]
