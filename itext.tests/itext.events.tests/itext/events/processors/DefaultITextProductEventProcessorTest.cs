...
namespace iText.Events.Processors {
    public class DefaultITextProductEventProcessorTest : ExtendedITextTest {
        ...
        public virtual void ConstructorWithNullProductNameTest() {
            ...
            , NUnit.Framework.Throws.InstanceOf<ArgumentException>().With.Message.EqualTo(EventsExceptionMessageConstant.PRODUCT_NAME_CAN_NOT_BE_NULL))
;
        }
    }
}
