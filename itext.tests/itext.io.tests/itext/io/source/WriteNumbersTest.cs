    ...
    public class WriteNumbersTest : ExtendedITextTest {
        ...
        public virtual void WriteNumber1Test() {
            ...
            for (int i = 0; i < 100000; i++) {
                ...
                byte[] expecteds = DecimalFormatUtil.FormatNumber(d, "0.##").GetBytes(iText.Events.Util.EncodingUtil.ISO_8859_1
                    );
                String message = "Expects: " + iText.Events.Util.JavaUtil.GetStringForBytes(expecteds) + ", actual: " + iText.Events.Util.JavaUtil.GetStringForBytes
                    (actuals) + " \\\\ " + d;
        ...
        public virtual void WriteNanTest() {
            double d = double.NaN;
            byte[] actuals = ByteUtils.GetIsoBytes(d);
            byte[] expecteds = DecimalFormatUtil.FormatNumber(0, "0.##").GetBytes(iText.Events.Util.EncodingUtil.ISO_8859_1
                );
            String message = "Expects: " + iText.Events.Util.JavaUtil.GetStringForBytes(expecteds) + ", actual: " + iText.Events.Util.JavaUtil.GetStringForBytes
                (actuals) + " \\\\ " + d;
            NUnit.Framework.Assert.AreEqual(expecteds, actuals, message);
