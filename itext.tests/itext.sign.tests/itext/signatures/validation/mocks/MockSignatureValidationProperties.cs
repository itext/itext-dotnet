...
namespace iText.Signatures.Validation.Mocks {
    ...
    public class MockSignatureValidationProperties : SignatureValidationProperties {
        ...
        public virtual iText.Signatures.Validation.Mocks.MockSignatureValidationProperties AddContinueAfterFailureResponse
            (bool value) {
            continueAfterFailureResponses.Add(value);
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockSignatureValidationProperties AddFreshnessResponse(TimeSpan
             freshness) {
            freshnessResponses.Add(freshness);
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockSignatureValidationProperties AddRequiredExtensionsResponses
            (IList<CertificateExtension> requiredExtensions) {
            requiredExtensionsResponses.Add(requiredExtensions);
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockSignatureValidationProperties AddRevocationOnlineFetchingResponse
