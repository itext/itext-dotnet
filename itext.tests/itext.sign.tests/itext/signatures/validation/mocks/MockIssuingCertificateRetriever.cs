...
namespace iText.Signatures.Validation.Mocks {
    public class MockIssuingCertificateRetriever : IssuingCertificateRetriever {
        ...
        public virtual iText.Signatures.Validation.Mocks.MockIssuingCertificateRetriever OnRetrieveMissingCertificatesDo
            (Func<IX509Certificate[], IX509Certificate[]> callback) {
            retrieveMissingCertificatesHandler = callback;
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockIssuingCertificateRetriever OngetCrlIssuerCertificatesDo
        ...
        public virtual iText.Signatures.Validation.Mocks.MockIssuingCertificateRetriever OnSetTrustedCertificatesDo
            (Action<ICollection<IX509Certificate>> callback) {
            setTrustedCertificatesHandler = callback;
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockIssuingCertificateRetriever OnAddKnownCertificatesDo(
            Action<ICollection<IX509Certificate>> callback) {
            addKnownCertificatesHandler = callback;
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockIssuingCertificateRetriever OnAddTrustedCertificatesDo
            (Action<ICollection<IX509Certificate>> callback) {
            addTrustedCertificatesHandler = callback;
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockIssuingCertificateRetriever OnIsCertificateTrustedDo(
            Func<IX509Certificate, bool> callback) {
            isCertificateTrustedDoHandler = callback;
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockIssuingCertificateRetriever OnGetTrustedCertificatesStoreDo
            (Func<TrustedCertificatesStore> callBack) {
            getTrustedCertificatesStoreHandler = callBack;
            return this;
        }

        public virtual iText.Signatures.Validation.Mocks.MockIssuingCertificateRetriever OnGetIssuerCertByURIHandlerDo
