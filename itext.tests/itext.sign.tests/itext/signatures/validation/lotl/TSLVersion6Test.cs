...
namespace iText.Signatures.Validation.Lotl {
    ...
    public class TSLVersion6Test : ExtendedITextTest {
        ...
        public static void BeforeAll() {
            ...
            EuropeanTrustedListConfigurationFactory.SetFactory(() => new _EuropeanTrustedListConfigurationFactory_87()
                );
        ...
        private sealed class _EuropeanTrustedListConfigurationFactory_87 : EuropeanTrustedListConfigurationFactory {
            public _EuropeanTrustedListConfigurationFactory_87() {
            }
