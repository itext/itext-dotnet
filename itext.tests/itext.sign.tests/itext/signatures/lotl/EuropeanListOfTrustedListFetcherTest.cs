...
//\cond DO_NOT_DOCUMENT
    ...
    internal class EuropeanListOfTrustedListFetcherTest : ExtendedITextTest {
        ...
        public virtual void DummmyRetrieverCausesException() {
            EuropeanListOfTrustedListFetcher fetcher = new EuropeanListOfTrustedListFetcher(new _IResourceRetriever_79
                ());
            NUnit.Framework.Assert.Catch(typeof(ITextException), () => fetcher.GetLotlData());
        }

        private sealed class _IResourceRetriever_79 : IResourceRetriever {
            public _IResourceRetriever_79() {
            }
