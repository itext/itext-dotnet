...
namespace iText.Kernel.Font {
    ...
    public class PdfType3FontTest : ExtendedITextTest {
        ...
        public virtual void AddAlreadyExistingGlyphTest() {
            ...
            dictionary.Put(PdfName.CharProcs, charProcs);
            dictionary.Put(PdfName.Widths, new PdfArray());
            PdfType3Font type3Font = new _PdfType3Font_85(dictionary);
        ...
        private sealed class _PdfType3Font_85 : PdfType3Font {
            public _PdfType3Font_85(PdfDictionary baseArg1)
                : base(baseArg1) {
            }
        ...
        public virtual void ContainsGlyphTest() {
            ...
            dictionary.Put(PdfName.CharProcs, charProcs);
            dictionary.Put(PdfName.Widths, new PdfArray());
            PdfType3Font type3Font = new _PdfType3Font_155(dictionary);
        ...
        private sealed class _PdfType3Font_155 : PdfType3Font {
            public _PdfType3Font_155(PdfDictionary baseArg1)
                : base(baseArg1) {
            }
        ...
        public virtual void FillFontDescriptorTest() {
            ...
            PdfType3Font type3Font = new _PdfType3Font_199(dictionary);
            NUnit.Framework.Assert.IsNotNull(type3Font.fontProgram);
            NUnit.Framework.Assert.IsNotNull(type3Font.fontProgram.GetFontNames());
            NUnit.Framework.Assert.AreEqual(fontStretch, type3Font.fontProgram.GetFontNames().GetFontStretch());
        }

        private sealed class _PdfType3Font_199 : PdfType3Font {
            public _PdfType3Font_199(PdfDictionary baseArg1)
                : base(baseArg1) {
            }
