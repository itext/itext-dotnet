...
namespace iText.Kernel.Font {
    public class PdfType3FontTest : ExtendedITextTest {
        ...
        public virtual void AddDifferentGlyphsInConstructorTest() {
            ...
            PdfType3Font type3Font = new _PdfType3Font_66(dictionary);
        ...
        private sealed class _PdfType3Font_66 : PdfType3Font {
            public _PdfType3Font_66(PdfDictionary baseArg1)
                : base(baseArg1) {
            }
        ...
        public virtual void AddAlreadyExistingGlyphTest() {
            ...
            dictionary.Put(PdfName.CharProcs, charProcs);
            dictionary.Put(PdfName.Widths, new PdfArray());
            PdfType3Font type3Font = new _PdfType3Font_91(dictionary);
        ...
        private sealed class _PdfType3Font_91 : PdfType3Font {
            public _PdfType3Font_91(PdfDictionary baseArg1)
                : base(baseArg1) {
            }
        ...
        public virtual void ContainsGlyphTest() {
            ...
            dictionary.Put(PdfName.CharProcs, charProcs);
            dictionary.Put(PdfName.Widths, new PdfArray());
            PdfType3Font type3Font = new _PdfType3Font_161(dictionary);
        ...
        private sealed class _PdfType3Font_161 : PdfType3Font {
            public _PdfType3Font_161(PdfDictionary baseArg1)
                : base(baseArg1) {
            }
        ...
        public virtual void FillFontDescriptorTest() {
            ...
            PdfType3Font type3Font = new _PdfType3Font_204(dictionary);
            NUnit.Framework.Assert.IsNotNull(type3Font.fontProgram);
            NUnit.Framework.Assert.IsNotNull(type3Font.fontProgram.GetFontNames());
            NUnit.Framework.Assert.AreEqual(fontStretch, type3Font.fontProgram.GetFontNames().GetFontStretch());
        }

        private sealed class _PdfType3Font_204 : PdfType3Font {
            public _PdfType3Font_204(PdfDictionary baseArg1)
                : base(baseArg1) {
            }
