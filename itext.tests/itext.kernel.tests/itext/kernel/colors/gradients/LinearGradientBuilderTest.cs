...
namespace iText.Kernel.Colors.Gradients {
    ...
    public class LinearGradientBuilderTest : ExtendedITextTest {
        ...
        private static readonly String DESTINATION_FOLDER = TestUtil.GetOutputPath() + "/kernel/colors/gradients/LinearGradientBuilderTest/";
        ...
        public virtual void BuildWithDecreasingOffsetsTest() {
            ...
            IGradientBuilder gradientBuilder = new LinearGradientBuilder().SetGradientVector(targetBoundingBox.GetLeft
                ...
                .RELATIVE).SetHint(120d, GradientColorStop.HintOffsetType.ABSOLUTE_ON_GRADIENT)).AddStopColor(new GradientColorStop
                (ColorConstants.BLUE.GetColorValue(), 1d, GradientColorStop.OffsetType.RELATIVE));
