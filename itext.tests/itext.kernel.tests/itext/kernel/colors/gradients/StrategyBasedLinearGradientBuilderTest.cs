...
namespace iText.Kernel.Colors.Gradients {
    ...
    public class StrategyBasedLinearGradientBuilderTest : ExtendedITextTest {
        ...
        private static readonly String DESTINATION_FOLDER = TestUtil.GetOutputPath() + "/kernel/colors/gradients/StrategyBasedLinearGradientBuilderTest/";
        ...
        public virtual void NoRectangleTest() {
            NUnit.Framework.Assert.IsNull(new StrategyBasedLinearGradientBuilder().AddStopColor(new GradientColorStop(
        ...
        public virtual void BuilderWithToCornerAndInnerStopsAndNoneSpreadingTest() {
            IGradientBuilder gradientBuilder = new StrategyBasedLinearGradientBuilder().SetGradientDirectionAsStrategy
                ...
                .RELATIVE)).AddStopColor(new GradientColorStop(ColorConstants.BLUE.GetColorValue(), 0.5d, GradientColorStop.OffsetType
                .RELATIVE));
