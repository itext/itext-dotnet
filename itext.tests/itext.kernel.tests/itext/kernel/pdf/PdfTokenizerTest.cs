...
namespace iText.Kernel.Pdf {
    public class PdfTokenizerTest : ExtendedITextTest {
        ...
        public virtual void EncodingTest() {
            ...
            tok = new PdfTokenizer(new RandomAccessFileOrArray(factory.CreateSource(testHexString.GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1
                ))));
            tok.NextToken();
            ...
            pdfString = new PdfString("FEFF041F04400438043204350442".GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1
                ), true);
            ...
            pdfString = new PdfString(specialCharacter.GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1), false);
            NUnit.Framework.Assert.AreEqual("\n\t\n\r\t\f", pdfString.ToUnicodeString());
            String symbol = "\u0001\u0004\u0006\u000E\u001F";
            pdfString = new PdfString(symbol.GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1), false);
            NUnit.Framework.Assert.AreEqual(symbol, pdfString.ToUnicodeString());
            String testString1 = "These\\\n two\\\r strings\\\n are the same";
            pdfString = new PdfString(testString1.GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1), false);
            ...
            pdfString = new PdfString(testString2.GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1), false);
            NUnit.Framework.Assert.AreEqual("This string contains \u00A5two octal characters\u00C7", pdfString.GetValue
                ());
            String testString3 = "\\0053";
            pdfString = new PdfString(testString3.GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1), false);
            NUnit.Framework.Assert.AreEqual("\u00053", pdfString.GetValue());
            String testString4 = "\\053";
            pdfString = new PdfString(testString4.GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1), false);
            NUnit.Framework.Assert.AreEqual("+", pdfString.GetValue());
            byte[] b = new byte[] { (byte)46, (byte)56, (byte)40 };
            pdfString = new PdfString(b, false);
            NUnit.Framework.Assert.AreEqual(iText.Events.Utils.JavaUtil.GetStringForBytes(b), pdfString.GetValue());
        }
