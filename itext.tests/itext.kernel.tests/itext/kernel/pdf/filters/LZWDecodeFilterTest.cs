...
namespace iText.Kernel.Pdf.Filters {
    public class LZWDecodeFilterTest : ExtendedITextTest {
        ...
        public virtual void DecodingTestStatic() {
            ...
            String decoded = iText.Events.Utils.JavaUtil.GetStringForBytes(LZWDecodeFilter.LZWDecode(bytes));
        ...
        public virtual void DecodingTestNonStatic() {
            ...
            String decoded = iText.Events.Utils.JavaUtil.GetStringForBytes(filter.Decode(bytes, null, new PdfDictionary
                (), new PdfDictionary()));
            NUnit.Framework.Assert.AreEqual(expectedResult, decoded);
        }
    }
