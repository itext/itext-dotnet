...
namespace iText.Kernel.Pdf {
    public class TagTreePointerTest : ExtendedITextTest {
        ...
        public virtual void TagTreePointerTest03() {
            ...
            NUnit.Framework.Assert.AreEqual(PdfException.TAG_TREE_POINTER_IS_IN_INVALID_STATE_IT_POINTS_AT_REMOVED_ELEMENT_USE_MOVE_TO_ROOT
                , exceptionMessage);
            ...
            NUnit.Framework.Assert.AreEqual(PdfException.TAG_TREE_POINTER_IS_IN_INVALID_STATE_IT_POINTS_AT_FLUSHED_ELEMENT_USE_MOVE_TO_ROOT
                , exceptionMessage);
            try {
            ...
            NUnit.Framework.Assert.AreEqual(PdfException.CANNOT_MOVE_TO_FLUSHED_KID, exceptionMessage);
            document.Close();
        }
        ...
        public virtual void TagStructureFlushingTest01() {
            ...
            document.Close();
            NUnit.Framework.Assert.AreEqual(PdfException.CANNOT_FLUSH_DOCUMENT_ROOT_TAG_BEFORE_DOCUMENT_IS_CLOSED, exceptionMessage
                );
