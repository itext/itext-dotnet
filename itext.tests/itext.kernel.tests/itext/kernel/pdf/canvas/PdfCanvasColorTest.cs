...
namespace iText.Kernel.Pdf.Canvas {
    public class PdfCanvasColorTest : ExtendedITextTest {
        ...
        public virtual void ColorTest06() {
            ...
            PdfDocument document = new PdfDocument(writer);
            PdfPage page = document.AddNewPage();
            PdfSpecialCs.Indexed indexed = new PdfSpecialCs.Indexed(PdfName.DeviceRGB, 255, new PdfString(iText.Events.Utils.JavaUtil.GetStringForBytes
                (bytes, "UTF-8")));
            PdfCanvas canvas = new PdfCanvas(page);
        ...
        public virtual void ColorTest07() {
            ...
            PdfFunction.Type4 function = new PdfFunction.Type4(new PdfArray(new float[] { 0, 1 }), new PdfArray(new float
                [] { 0, 1, 0, 1, 0, 1 }), "{0 0}".GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1));
        ...
        public virtual void ColorTest08() {
            ...
            PdfFunction.Type4 function = new PdfFunction.Type4(new PdfArray(new float[] { 0, 1, 0, 1 }), new PdfArray(
                new float[] { 0, 1, 0, 1, 0, 1 }), "{0}".GetBytes(iText.Events.Utils.EncodingUtil.ISO_8859_1));
        ...
        public virtual void PatternColorColoredSetTwiceTest() {
            ...
            canvas.Release();
            document.Close();
            String contentStreamString = iText.Events.Utils.JavaUtil.GetStringForBytes(pageContentStreamBytes, System.Text.Encoding
                .ASCII);
