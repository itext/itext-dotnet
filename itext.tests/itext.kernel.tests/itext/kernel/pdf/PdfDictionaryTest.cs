    ...
    public class PdfDictionaryTest {
        ...
        public virtual void TestEntrySet() {
            ...
            foreach (KeyValuePair<PdfName, PdfObject> e in dict.EntrySet()) {
                ...
                if (!nums.Remove((Object)((PdfNumber)e.Value).IntValue())) {
        ...
        [NUnit.Framework.Test]
        public virtual void TestValuesRemove() {
            PdfDocument doc = new PdfDocument(new PdfWriter(new ByteArrayOutputStream()));
            PdfDictionary dict = new PdfDictionary();
            dict.Put(new PdfName("1"), ((PdfNumber)new PdfNumber(1).MakeIndirect(doc)).GetIndirectReference());
            dict.Put(new PdfName("2"), ((PdfNumber)new PdfNumber(2).MakeIndirect(doc)).GetIndirectReference());
            ...
            dict.Put(new PdfName("5"), new PdfNumber(5));
            dict.Put(new PdfName("6"), new PdfNumber(6));
            IList<PdfObject> toRemove = new List<PdfObject>();
            foreach (PdfObject v in dict.Values()) {
                toRemove.Add(v);
            }
            foreach (PdfObject v_1 in toRemove) {
                NUnit.Framework.Assert.IsTrue(dict.Values().Remove(v_1));
            }
            NUnit.Framework.Assert.AreEqual(0, dict.EntrySet().Count);
            NUnit.Framework.Assert.AreEqual(0, dict.Values().Count);
            NUnit.Framework.Assert.AreEqual(0, dict.Size());
        ...
        public virtual void TestValuesIndirectRemove() {
            ...
            dict.Put(new PdfName("5"), new PdfNumber(5));
            dict.Put(new PdfName("6"), new PdfNumber(6));
            NUnit.Framework.Assert.IsTrue(dict.Values().Remove(dict.Get(new PdfName("1"), false)));
            NUnit.Framework.Assert.IsTrue(dict.Values().Remove(dict.Get(new PdfName("2"), false)));
            NUnit.Framework.Assert.IsTrue(dict.Values().Remove(dict.Get(new PdfName("3")).GetIndirectReference()));
            NUnit.Framework.Assert.IsTrue(dict.Values().Remove(dict.Get(new PdfName("4")).GetIndirectReference()));
            NUnit.Framework.Assert.AreEqual(2, dict.EntrySet().Count);
            NUnit.Framework.Assert.AreEqual(2, dict.Values().Count);
            NUnit.Framework.Assert.AreEqual(2, dict.Size());
        }

        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("DEVSIX-851")]
        public virtual void TestValuesRemove2() {
            PdfDocument doc = new PdfDocument(new PdfWriter(new ByteArrayOutputStream()));
            PdfDictionary dict = new PdfDictionary();
            dict.Put(new PdfName("1"), ((PdfNumber)new PdfNumber(1).MakeIndirect(doc)).GetIndirectReference());
            dict.Put(new PdfName("2"), ((PdfNumber)new PdfNumber(2).MakeIndirect(doc)).GetIndirectReference());
            ...
            dict2.Put(new PdfName("5"), new PdfNumber(5));
            dict2.Put(new PdfName("6"), new PdfNumber(6));
            foreach (PdfObject v in dict2.Values()) {
                NUnit.Framework.Assert.IsTrue(dict.Values().Remove(v));
            }
            NUnit.Framework.Assert.AreEqual(0, dict.EntrySet().Count);
            NUnit.Framework.Assert.AreEqual(0, dict.Values().Count);
            NUnit.Framework.Assert.AreEqual(0, dict.Size());
        ...
        [NUnit.Framework.Test]
        public virtual void TestValuesRemoveAll() {
            PdfDocument doc = new PdfDocument(new PdfWriter(new ByteArrayOutputStream()));
            PdfDictionary dict = new PdfDictionary();
            dict.Put(new PdfName("1"), ((PdfNumber)new PdfNumber(1).MakeIndirect(doc)).GetIndirectReference());
            dict.Put(new PdfName("2"), ((PdfNumber)new PdfNumber(2).MakeIndirect(doc)).GetIndirectReference());
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("DEVSIX-851")]
        public virtual void TestValuesRemoveAll2() {
            PdfDocument doc = new PdfDocument(new PdfWriter(new ByteArrayOutputStream()));
            PdfDictionary dict = new PdfDictionary();
            dict.Put(new PdfName("1"), ((PdfNumber)new PdfNumber(1).MakeIndirect(doc)).GetIndirectReference());
            dict.Put(new PdfName("2"), ((PdfNumber)new PdfNumber(2).MakeIndirect(doc)).GetIndirectReference());
        ...
        [NUnit.Framework.Test]
        public virtual void TestValuesRetainAll() {
            PdfDocument doc = new PdfDocument(new PdfWriter(new ByteArrayOutputStream()));
            PdfDictionary dict = new PdfDictionary();
            dict.Put(new PdfName("1"), ((PdfNumber)new PdfNumber(1).MakeIndirect(doc)).GetIndirectReference());
            dict.Put(new PdfName("2"), ((PdfNumber)new PdfNumber(2).MakeIndirect(doc)).GetIndirectReference());
        ...
        [NUnit.Framework.Test]
        public virtual void TestValuesClear() {
            PdfDocument doc = new PdfDocument(new PdfWriter(new ByteArrayOutputStream()));
            PdfDictionary dict = new PdfDictionary();
            dict.Put(new PdfName("1"), ((PdfNumber)new PdfNumber(1).MakeIndirect(doc)).GetIndirectReference());
            dict.Put(new PdfName("2"), ((PdfNumber)new PdfNumber(2).MakeIndirect(doc)).GetIndirectReference());
