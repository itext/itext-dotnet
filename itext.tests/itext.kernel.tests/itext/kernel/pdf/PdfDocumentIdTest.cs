...
namespace iText.Kernel.Pdf {
    ...
    public class PdfDocumentIdTest : ExtendedITextTest {
        ...
        public virtual void FetchReaderIdTest() {
            ...
            PdfReader reader = new PdfReader(new MemoryStream(documentBytes));
            pdfDocument = new PdfDocument(reader);
            String firstOriginalId = iText.Events.Util.JavaUtil.GetStringForBytes(reader.GetOriginalFileId());
            String secondOriginalId = iText.Events.Util.JavaUtil.GetStringForBytes(reader.GetOriginalFileId());
            String firstModifiedId = iText.Events.Util.JavaUtil.GetStringForBytes(reader.GetModifiedFileId());
            String secondModifiedId = iText.Events.Util.JavaUtil.GetStringForBytes(reader.GetModifiedFileId());
