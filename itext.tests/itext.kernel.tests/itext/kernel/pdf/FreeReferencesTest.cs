...
namespace iText.Kernel.Pdf {
    public class FreeReferencesTest : ExtendedITextTest {
        ...
        public virtual void FreeReferencesTest03() {
            ...
            String firstPageData = iText.Events.Utils.JavaUtil.GetStringForBytes(firstPageContentStream.GetBytes());
        ...
        private bool CompareXrefSection(String xrefSection, String expectedSection) {
            String[] xrefEntries = iText.Events.Utils.StringUtil.Split(xrefSection, "\n");
            String[] expectedEntries = iText.Events.Utils.StringUtil.Split(expectedSection, "\n");
        ...
        private String[] ExtractXrefTableAsStrings(String @out) {
            ...
            String outPdfContent = iText.Events.Utils.JavaUtil.GetStringForBytes(outPdfBytes, System.Text.Encoding.ASCII
                );
            String xrefStr = "\nxref";
