...
namespace iText.Kernel.Pdf {
    public class FreeReferencesTest : ExtendedITextTest {
        ...
        public virtual void FreeReferencesTest03() {
            ...
            String firstPageData = iText.Events.Util.JavaUtil.GetStringForBytes(firstPageContentStream.GetBytes());
        ...
        private String[] ExtractXrefTableAsStrings(String @out) {
            ...
            String outPdfContent = iText.Events.Util.JavaUtil.GetStringForBytes(outPdfBytes, System.Text.Encoding.ASCII
                );
            String xrefStr = "\nxref";
