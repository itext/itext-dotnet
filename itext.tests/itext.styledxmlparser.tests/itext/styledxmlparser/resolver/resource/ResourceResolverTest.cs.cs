...
namespace iText.StyledXmlParser.Resolver.Resource {
    class ResourceResolverTest : ExtendedITextTest {
        public static readonly String baseUri = iText.Test.TestUtil.GetParentProjectDirectory(NUnit.Framework.TestContext
           .CurrentContext.TestDirectory) + "/resources/itext/styledxmlparser/resolver/resources/retrieveStreamTest/";
        ...
        /// <exception cref="Java.Net.MalformedURLException"/>
        [NUnit.Framework.Test]
        public virtual void ResourceResolverTest01A() {
        ...
        /// <exception cref="Java.Net.MalformedURLException"/>
        [NUnit.Framework.Test]
        public virtual void ResourceResolverTest14() {
        ...
        /// <exception cref="Java.Net.MalformedURLException"/>
        [NUnit.Framework.Test]
        public virtual void ResourceResolverTest16() {
            String absolutePathRoot = "file:///" + Path.GetPathRoot((Directory.GetCurrentDirectory() + "/")).Replace
                ('\\', '/').ReplaceFirst("^/", "");
            String absoluteBaseUri = absolutePathRoot + "test/folder/index.html";
            ResourceResolver resolver = new ResourceResolver(absoluteBaseUri);
        ...
        /// <exception cref="Java.Net.MalformedURLException"/>
        [NUnit.Framework.Test]
        public virtual void ResourceResolverTest17() {
            String absolutePathRoot = "file:///" + Path.GetPathRoot((Directory.GetCurrentDirectory() + "/")).Replace
                ('\\', '/').ReplaceFirst("^/", "");
        ...
        public virtual void RetrieveStyleSheetTest() {
            ...
            ResourceResolver resourceResolver = new ResourceResolver(baseUri);
            System.IO.Stream stream = resourceResolver.RetrieveStyleSheet("retrieveStyleSheetTest.css");
