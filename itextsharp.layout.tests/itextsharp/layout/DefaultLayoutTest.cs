...
namespace iTextSharp.Layout
{
	...
	{
		public const String sourceFolder = "../../resources/itextsharp/layout/DefaultLayoutTest/";

		public const String destinationFolder = "test/itextsharp/layout/DefaultLayoutTest/";
		...
		public virtual void RendererTest01()
		{
			...
			document.Add(new Paragraph(new Text(str).SetBackgroundColor(iTextSharp.Kernel.Color.Color
				.RED)).SetBackgroundColor(iTextSharp.Kernel.Color.Color.GREEN)).Add(new Paragraph
				(str)).Add(new AreaBreak(PageSize.Default)).Add(new Paragraph(str));
			document.Close();
			NUnit.Framework.Assert.IsNull(new CompareTool().CompareByContent(outFileName, cmpFileName
				, destinationFolder, "diff"));
		}
		...
		public virtual void EmptyParagraphsTest01()
		{
			...
			document.Add(new Paragraph().SetBorder(new SolidBorder(iTextSharp.Kernel.Color.Color
				.BLUE, 3)));
