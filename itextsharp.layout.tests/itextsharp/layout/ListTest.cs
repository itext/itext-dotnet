...
namespace iTextSharp.Layout
{
	...
	{
		public const String sourceFolder = "../../resources/itextsharp/layout/ListTest/";

		public const String destinationFolder = "test/itextsharp/layout/ListTest/";
		...
		public virtual void NestedListTest01()
		{
			...
			List list = new List(ListNumberingType.DECIMAL).SetSymbolIndent(20).Add("One").Add
				("Two").Add("Three").Add("Four").Add((ListItem)new ListItem("Roman List").Add(romanList
		...
		public virtual void ListItemTest01()
		{
			...
			list.Add(new ListItem("The quick brown").SetListSymbol(ListNumberingType.ZAPF_DINGBATS_1
				)).Add(new ListItem("fox").SetListSymbol(ListNumberingType.ZAPF_DINGBATS_2)).Add
				(new ListItem("jumps over the lazy").SetListSymbol(ListNumberingType.ZAPF_DINGBATS_3
