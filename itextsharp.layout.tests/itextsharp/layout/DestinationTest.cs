...
namespace iTextSharp.Layout
{
	...
	{
		public const String sourceFolder = "../../resources/itextsharp/layout/DestinationTest/";

		public const String destinationFolder = "test/itextsharp/layout/DestinationTest/";
