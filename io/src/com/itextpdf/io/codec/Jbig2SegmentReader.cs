/*
$Id: 236522090de94c7538f8eb5e1eb27a87d4f81833 $
	...
	public class Jbig2SegmentReader
	{
		...
		internal virtual void ReadSegment(Jbig2SegmentReader.Jbig2Segment s)
		{
			...
			if (s.type == PAGE_INFORMATION)
			{
				...
				if (p == null)
				{
					throw new InvalidOperationException("referring.to.widht.height.of.page.we.havent.seen.yet.1"
						);
				}
				//TODO, s.page);
		...
		internal virtual Jbig2SegmentReader.Jbig2Segment ReadHeader()
		{
			...
			else
			{
				...
				else
				{
					...
					{
						throw new InvalidOperationException("count.of.referred.to.segments.had.bad.value.in.header.for.segment.1.starting.at.2"
							);
					}
				}
			}
			...
			{
				throw new InvalidOperationException("page.1.invalid.for.segment.2.starting.at.3");
			}
		...
		internal virtual void ReadFileHeader()
		{
			...
			for (int i = 0; i < idstring.Length; i++)
			{
				...
				{
					throw new InvalidOperationException("file.header.idstring.not.good.at.byte.1");
				}
			}
			//TODO, i);
