/*
$Id: 63349af88b8ee813130ccf61deb558591c720a34 $
...
namespace com.itextpdf.io.image
{
	public class GifImage
	{
		...
		private IList<Image> frames = new List<Image>();

		private byte[] data;

		private Uri url;

		protected internal GifImage(Uri url)
		{
			this.url = url;
		}

		protected internal GifImage(byte[] data)
		{
			this.data = data;
		}
		...
		public virtual IList<Image> GetFrames()
		{
			return frames;
		}
		...
		protected internal virtual void AddFrame(Image frame)
		{
			frames.Add(frame);
		}
