/*
$Id: 0f8f17e3094d244c3006df133b27fa355400cb38 $
...
{
	public class Jpeg2000Image : Image
	{
		public class Parameters
		{
			public int numOfComps;

			public IList<Jpeg2000Image.ColorSpecBox> colorSpecBoxes = null;
		...
		protected internal Jpeg2000Image.Parameters parameters;

		protected internal Jpeg2000Image(Uri url)
			: base(url, ImageType.JPEG2000)
		{
		}

		protected internal Jpeg2000Image(byte[] bytes)
		...
		{
			Logger logger = LoggerFactory.GetLogger(typeof(Image));
			logger.Warn(LogMessageConstant.IMAGE_HAS_JPXDECODE_FILTER);
			return false;
		}

		public virtual Jpeg2000Image.Parameters GetParameters()
		{
			return parameters;
		}
	}
