/*
$Id: 4baf3e7c1fbae53002af916165df0393b35c46bb $
...
{
	public class Jbig2Image : Image
	{
		private int page;

		protected internal Jbig2Image(Uri url, int page)
			: base(url, ImageType.JBIG2)
		{
			this.page = page;
		}

		protected internal Jbig2Image(byte[] bytes, int page)
