/*
$Id: 71e1261c96440c1555ec652be7acde1ea28bcd23 $
...
namespace com.itextpdf.io.image
{
	public abstract class Image
	{
		...
		protected internal com.itextpdf.io.image.Image imageMask;
		...
		protected internal Image(Uri url, ImageType type)
		{
			this.url = url;
			this.originalType = type;
		}

		protected internal Image(byte[] bytes, ImageType type)
		{
			this.data = bytes;
			this.originalType = type;
		}
		...
		public virtual com.itextpdf.io.image.Image GetImageMask()
		{
			return imageMask;
		}

		public virtual void SetImageMask(com.itextpdf.io.image.Image imageMask)
		{
			if (this.mask)
			{
		...
		{
			Logger logger = LoggerFactory.GetLogger(typeof(com.itextpdf.io.image.Image));
			if (imageSize > 4096)
			{
