/*
$Id: d614201ab383eb52f6e4a093f2a4d3f4a1484a49 $
...
namespace com.itextpdf.io.font
{
	...
	internal class TrueTypeFontSubset
	{
		...
		protected internal virtual void AssembleFont()
		{
			...
			com.itextpdf.io.util.JavaUtil.CollectionsAddAll(tableNames, tableNamesSimple);
			if (includeExtras)
			{
				com.itextpdf.io.util.JavaUtil.CollectionsAddAll(tableNames, tableNamesExtra);
			}
			else
			{
				if (includeCmap)
				{
					com.itextpdf.io.util.JavaUtil.CollectionsAddAll(tableNames, tableNamesCmap);
				}
			}
			int tablesUsed = 2;
