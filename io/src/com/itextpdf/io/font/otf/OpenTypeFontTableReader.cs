/*
* $Id: 5d2c85e7383d643d6b2ba82ac9a1b44181aa8848 $
*
...
namespace com.itextpdf.io.font.otf
{
	...
	public abstract class OpenTypeFontTableReader
	{
		...
		protected internal virtual int GetGlyphWidth(int index)
		{
			Glyph glyph = indexGlyphMap[index];
			if (glyph == null)
			{
				return 0;
			}
		...
		public virtual int GetGlyphToCharacter(int index)
		{
			Glyph glyph = indexGlyphMap[index];
			if (glyph == null)
			{
		...
		/// method.
		/// </remarks>
		/// <exception cref="FontReadingException"></exception>
		/// <exception cref="com.itextpdf.io.font.otf.FontReadingException"/>
		protected internal void StartReadingTable()
		{
			try
			{
