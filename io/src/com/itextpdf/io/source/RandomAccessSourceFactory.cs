...
namespace com.itextpdf.io.source
{
	...
	public sealed class RandomAccessSourceFactory
	{
		...
		public RandomAccessSource CreateSource(FileStream raf)
		{
		...
		/// </returns>
		/// <exception cref="System.IO.IOException"/>
		public RandomAccessSource CreateSource(Uri url)
		{
		...
		/// </returns>
		/// <exception cref="System.IO.IOException"/>
		public RandomAccessSource CreateSource(Stream inputStream)
		{
		...
		/// <exception cref="System.IO.IOException">if reading the underling file or stream fails
		/// 	</exception>
		private RandomAccessSource CreateByReadingToMemory(Stream stream)
		{
			try
			{
