...
namespace iTextSharp.Samples.Signatures.Chapter03
{
	public class C3_03_SignWithCRLDefaultImp : C3_01_SignWithCAcert
	{
	    ...
	    public static readonly string DEST = NUnit.Framework.TestContext.CurrentContext.TestDirectory + "/test/resources/signatures/chapter03/hello_cacert_crl_imp.pdf";
