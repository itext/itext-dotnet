...
namespace iTextSharp.Samples.Signatures.Chapter02
{
	public class C2_11_SignatureWorkflow : SignatureTest
	{
        ...
        public static readonly string DEST = NUnit.Framework.TestContext.CurrentContext.TestDirectory + "/test/resources/signatures/chapter02/step%s_signed_by_%s.pdf";
