...
namespace iText.Svg.Processors.Impl {
    ...
    internal class FontFace {
        ...
        /// instance
        /// </returns>
        public static iText.Svg.Processors.Impl.FontFace Create(IList<CssDeclaration> properties) {
            ...
            if (sources.Count > 0) {
                return new iText.Svg.Processors.Impl.FontFace(fontFamily, sources);
            }
            else {
                return null;
            }
