...
namespace iText.Svg.Css.Impl {
    ...
    public class SvgStyleResolver : ICssResolver {
        ...
        private static readonly String[] ELEMENTS_INHERITING_PARENT_STYLES = new String[] { SvgConstants.Tags.MARKER
            , SvgConstants.Tags.MASK, SvgConstants.Tags.LINEAR_GRADIENT, StringNormalizer.ToLowerCase(SvgConstants.Tags
            .LINEAR_GRADIENT), SvgConstants.Tags.RADIAL_GRADIENT, StringNormalizer.ToLowerCase(SvgConstants.Tags.RADIAL_GRADIENT
