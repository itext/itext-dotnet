...
namespace iText.Svg.Renderers {
    ...
    /// object.
    /// </remarks>
    public interface ISvgPaintServer : INoDrawSvgNodeRenderer {
        /// <summary>
        /// Creates the
        ...
        Color CreateColor(SvgDrawContext context, Rectangle objectBoundingBox, float objectBoundingBoxMargin, float
             parentOpacity);
    }
}
