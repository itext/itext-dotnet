...
namespace iText.Svg.Logs {
    ...
    public sealed class SvgLogMessageConstant {
        ...
        public const String MARKER_WIDTH_IS_NEGATIVE_VALUE = "markerWidth has negative value. Marker will not " + 
            "be rendered.";
        ...
        public const String MISSING_HEIGHT = "Top Svg tag has no defined height attribute and viewbox height is not "
