    ...
    public class TextRenderer : AbstractRenderer, ILeafElementRenderer {
        ...
        public override void Draw(DrawContext drawContext) {
            ...
            if (line.end > line.start || savedWordBreakAtLineEnding != null) {
                ...
                GlyphLine.IGlyphLineFilter filter = new _IGlyphLineFilter_951();
        ...
        private sealed class _IGlyphLineFilter_951 : GlyphLine.IGlyphLineFilter {
            public _IGlyphLineFilter_951() {
            }
