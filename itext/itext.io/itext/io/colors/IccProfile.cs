...
namespace iText.IO.Colors {
    ...
    public class IccProfile {
        ...
        public static String GetIccColorSpaceName(byte[] data) {
            String colorSpace;
            try {
                colorSpace = iText.Events.Utils.JavaUtil.GetStringForBytes(data, 16, 4, "US-ASCII");
            }
        ...
        public static String GetIccDeviceClass(byte[] data) {
            String deviceClass;
            try {
                deviceClass = iText.Events.Utils.JavaUtil.GetStringForBytes(data, 12, 4, "US-ASCII");
            }
            catch (ArgumentException e) {
                throw new iText.IO.IOException(iText.IO.IOException.InvalidIccProfile, e);
            }
