                ...
                if (v == 0xFF) {
                    ...
                    if (marker == M_APPE) {
                        ...
                        if (byteappe.Length >= 12) {
                            String appe = iText.Events.Utils.JavaUtil.GetStringForBytes(byteappe, 0, 5, "ISO-8859-1");
                    ...
                    if (marker == M_APP2) {
                        ...
                        if (byteapp2.Length >= 14) {
                            String app2 = iText.Events.Utils.JavaUtil.GetStringForBytes(byteapp2, 0, 11, "ISO-8859-1");
