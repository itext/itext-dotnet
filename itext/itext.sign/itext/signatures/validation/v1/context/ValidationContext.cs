...
namespace iText.Signatures.Validation.V1.Context {
    ...
    public class ValidationContext {
        ...
        private iText.Signatures.Validation.V1.Context.ValidationContext previousValidationContext;
        ...
        /// instance
        /// </returns>
        public virtual iText.Signatures.Validation.V1.Context.ValidationContext GetPreviousValidationContext() {
        ...
        /// otherwise
        /// </returns>
        public static bool CheckIfContextChainContainsCertificateSource(iText.Signatures.Validation.V1.Context.ValidationContext
