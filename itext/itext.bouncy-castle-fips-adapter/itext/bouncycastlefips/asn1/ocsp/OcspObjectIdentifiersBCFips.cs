...
namespace iText.Bouncycastlefips.Asn1.Ocsp {
    ...
    public class OcspObjectIdentifiersBCFips : IOcspObjectIdentifiers {
        private static readonly OcspObjectIdentifiersBCFips INSTANCE = new OcspObjectIdentifiersBCFips(null);

        private static readonly IDerObjectIdentifier ID_PKIX_OCSP_BASIC = new DerObjectIdentifierBCFips(OcspObjectIdentifiers
            .PkixOcspBasic);

        private static readonly IDerObjectIdentifier ID_PKIX_OCSP_NONCE = new DerObjectIdentifierBCFips(OcspObjectIdentifiers
            .PkixOcspNonce);
        ...
        public virtual IDerObjectIdentifier GetIdPkixOcspBasic() {
            return ID_PKIX_OCSP_BASIC;
        }

        /// <summary><inheritDoc/></summary>
        public virtual IDerObjectIdentifier GetIdPkixOcspNonce() {
