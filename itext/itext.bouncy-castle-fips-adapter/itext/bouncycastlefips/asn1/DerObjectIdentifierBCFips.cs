...
namespace iText.Bouncycastlefips.Asn1 {
    ...
    /// </summary>
    public class DerObjectIdentifierBCFips : Asn1ObjectBCFips, IDerObjectIdentifier {
        /// <summary>
        ...
        /// <see cref="Org.BouncyCastle.Asn1.DerObjectIdentifier"/>
        /// </param>
        public DerObjectIdentifierBCFips(String identifier)
        ...
        /// to be wrapped
        /// </param>
        public DerObjectIdentifierBCFips(DerObjectIdentifier identifier)
            : base(identifier) {
        }
