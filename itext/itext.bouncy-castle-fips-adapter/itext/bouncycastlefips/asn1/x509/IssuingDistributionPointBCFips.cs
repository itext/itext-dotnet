...
namespace iText.Bouncycastlefips.Asn1.X509 {
    ...
    /// </summary>
    public class IssuingDistributionPointBCFips : Asn1EncodableBCFips, IIssuingDistributionPoint {
        /// <summary>
        ...
        public virtual IDistributionPointName GetDistributionPoint() {
            return new DistributionPointNameBCFips(GetIssuingDistributionPoint().DistributionPoint);
        }
        ...
        public virtual IReasonFlags GetOnlySomeReasons() {
            return new ReasonFlagsBCFips(GetIssuingDistributionPoint().OnlySomeReasons);
        }
    }
}
