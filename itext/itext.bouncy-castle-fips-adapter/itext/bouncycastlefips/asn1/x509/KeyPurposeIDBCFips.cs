...
namespace iText.Bouncycastlefips.Asn1.X509 {
    ...
    public class KeyPurposeIDBCFips : Asn1EncodableBCFips, IKeyPurposeID {
        private static readonly KeyPurposeIDBCFips INSTANCE = new KeyPurposeIDBCFips(null);

        private static readonly KeyPurposeIDBCFips ID_KP_OCSP_SIGNING = new KeyPurposeIDBCFips(KeyPurposeID.IdKPOcspSigning
            );
