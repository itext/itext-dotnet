...
namespace iText.Bouncycastlefips.Asn1.X509.Qualified {
    /// <summary>Wrapper class for QCStatement.</summary>
    public class QCStatementBCFips : Asn1EncodableBCFips, IQCStatement {
        /// <summary>
        ...
        public virtual IDerObjectIdentifier GetStatementId() {
            return new DerObjectIdentifierBCFips(GetQCStatement().StatementId);
        }
        ...
        public virtual IAsn1Encodable GetStatementInfo() {
            return new Asn1EncodableBCFips(GetQCStatement().StatementInfo);
        }
    }
}
