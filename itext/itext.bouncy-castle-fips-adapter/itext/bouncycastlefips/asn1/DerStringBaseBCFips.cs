...
namespace iText.Bouncycastlefips.Asn1 {
    ...
    /// </summary>
    public class DerStringBaseBCFips : IDerStringBase {
        ...
        /// to be wrapped
        /// </param>
        public DerStringBaseBCFips(DerStringBase asn1String) {
        ...
        /// <see cref="Org.BouncyCastle.Asn1.DerStringBase"/>.
        /// </returns>
        public virtual DerStringBase GetDerStringBase() {
            return asn1String;
        }
        ...
        public override bool Equals(Object o) {
            ...
            DerStringBaseBCFips that = (DerStringBaseBCFips)o;
