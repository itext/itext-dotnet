...
namespace iText.Bouncycastlefips.Cert.Ocsp {
    ...
    /// </summary>
    public class OcspRequestBCFips : IOcspRequest {
        ...
        /// to be wrapped
        /// </param>
        public OcspRequestBCFips(OcspRequest ocspReq) {
        ...
        /// byte array
        /// </param>
        public OcspRequestBCFips(ICertID certId, byte[] documentId) {
            ...
            vector.Add(new Request(((CertIDBCFips) certId).GetCertificateID(), (X509Extensions)null));
        ...
        /// <see cref="Org.BouncyCastle.Asn1.Ocsp.OcspRequest"/>.
        /// </returns>
        public virtual OcspRequest GetOcspRequest() {
            return ocspReq;
        }
        ...
        public IX509Extension GetExtension(IDerObjectIdentifier objectIdentifier) {
            return new X509ExtensionBCFips(ocspReq.TbsRequest.RequestExtensions.GetExtension(
                ((DerObjectIdentifierBCFips) objectIdentifier).GetDerObjectIdentifier()));
        }
        ...
        public override bool Equals(Object o) {
            ...
            iText.Bouncycastlefips.Cert.Ocsp.OcspRequestBCFips that = (iText.Bouncycastlefips.Cert.Ocsp.OcspRequestBCFips)o;
