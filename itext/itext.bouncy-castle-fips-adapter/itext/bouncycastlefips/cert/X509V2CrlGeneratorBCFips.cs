...
namespace iText.Bouncycastlefips.Cert {
    ...
    /// </summary>
    public class X509V2CrlGeneratorBCFips : IX509V2CrlGenerator {
        ...
        /// to be wrapped
        /// </param>
        public X509V2CrlGeneratorBCFips(X509V2CrlGenerator builder) {
        ...
        /// <see cref="Org.BouncyCastle.Cert.X509V2CrlGenerator"/>
        /// </param>
        public X509V2CrlGeneratorBCFips(IX500Name x500Name, DateTime date) {
        ...
        public override bool Equals(Object o) {
            ...
            iText.Bouncycastlefips.Cert.X509V2CrlGeneratorBCFips that = (iText.Bouncycastlefips.Cert.X509V2CrlGeneratorBCFips
                )o;
