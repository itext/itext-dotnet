...
namespace iText.StyledXmlParser.Jsoup.Select {
    ...
    /// </td><td><code>div:not(.logo)</code> finds all divs that do not have the "logo" class.<para /><code>div:not(:has(div))</code> finds divs that do not contain divs.</p></td></tr>
