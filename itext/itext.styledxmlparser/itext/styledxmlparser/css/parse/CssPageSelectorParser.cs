...
namespace iText.StyledXmlParser.Css.Parse {
    ...
    public sealed class CssPageSelectorParser {
        ...
        private static readonly Regex selectorPattern = iText.Events.Utils.StringUtil.RegexCompile(PAGE_SELECTOR_PATTERN_STR
            );
        ...
        public static IList<ICssSelectorItem> ParseSelectorItems(String selectorItemsStr) {
            ...
            Matcher itemMatcher = iText.Events.Utils.Matcher.Match(selectorPattern, selectorItemsStr);
