    ...
    internal class CssPropertyNormalizer {
                ...
                if (str[i] == '\\') {
                    ...
                    if (iText.IO.Util.TextUtil.IsWhiteSpace(str[i])) {
                        ...
                        if (str[i] == '\'' || str[i] == '"') {
                            ...
                            if ((str[i] == 'u' || str[i] == 'U') && iText.Events.Utils.Matcher.Match(URL_PATTERN, str.Substring(i)).Find
                                ()) {
        ...
        private static int AppendQuotedString(StringBuilder buffer, String source, int start) {
            ...
            if (end == -1) {
                ...
                ITextLogManager.GetLogger(typeof(CssPropertyNormalizer)).LogWarning(MessageFormatUtil.Format(iText.StyledXmlParser.LogMessageConstant
