...
namespace iText.Events {
    public sealed class ProductNameConstant {
        ...
        public static readonly ICollection<String> PRODUCT_NAMES = JavaCollectionsUtil.UnmodifiableSet(new HashSet
            <String>(JavaUtil.ArraysAsList(iText.Events.ProductNameConstant.ITEXT_CORE, iText.Events.ProductNameConstant
            .PDF_HTML, iText.Events.ProductNameConstant.PDF_SWEEP, iText.Events.ProductNameConstant.PDF_OCR_TESSERACT4
            )));
