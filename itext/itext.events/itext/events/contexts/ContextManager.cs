...
namespace iText.Events.Contexts {
    ...
    public class ContextManager {
        private static readonly iText.Events.Contexts.ContextManager INSTANCE;
        ...
        static ContextManager() {
            iText.Events.Contexts.ContextManager local = new iText.Events.Contexts.ContextManager();
        ...
        /// instance
        /// </returns>
        public static iText.Events.Contexts.ContextManager GetInstance() {
            return INSTANCE;
        }
