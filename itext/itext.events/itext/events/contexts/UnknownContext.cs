...
namespace iText.Events.Contexts {
    ...
    public class UnknownContext : IContext {
        ...
        /// </summary>
        public static readonly IContext RESTRICTIVE = new iText.Events.Contexts.UnknownContext(false);
        ...
        /// </summary>
        public static readonly IContext PERMISSIVE = new iText.Events.Contexts.UnknownContext(true);
