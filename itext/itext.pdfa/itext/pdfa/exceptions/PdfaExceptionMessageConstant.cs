...
namespace iText.Pdfa.Exceptions {
    ...
    public sealed class PdfaExceptionMessageConstant {
        ...
        public const String A_FORM_XOBJECT_DICTIONARY_SHALL_NOT_CONTAIN_REF_KEY = "A form xobject dictionary shall not contain ref key";
        ...
        public const String ALL_HALFTONES_CONTAINING_TRANSFER_FUNCTION_SHALL_HAVE_HALFTONETYPE_5 = "The TransferFunction key in a halftone dictionary can only be present if it is a component in a Type 5 halftone dictionary representing a colorant other than Cyan, Magenta, Yellow or Black.";
        ...
        public const String SIGNATURE_SHALL_CONFORM_TO_ONE_OF_THE_PADES_PROFILE = "Signature shall conform to one of the PAdES profiles from either ISO 32000-2 or ISO 14533-3.";

        public const String DEVICERGB_SHALL_ONLY_BE_USED_IF_CURRENT_RGB_PDFA_OUTPUT_INTENT_OR_DEFAULTRGB_IN_USAGE_CONTEXT
             ...
             + "colour space is used, is a device independent RGB-based colour space or the current " + "PDF/A OutputIntent, when the DeviceRGB colour space is used, contains an ‘RGB ’ destination "
             + "profile.";

        public const String DEVICECMYK_SHALL_ONLY_BE_USED_IF_CURRENT_CMYK_PDFA_OUTPUT_INTENT_OR_DEFAULTCMYK_IN_USAGE_CONTEXT
             = "DeviceCMYK shall only be used if a device independent DefaultCMYK colour space has been set when the "
             + "DeviceCMYK colour space is used or if the current transparency blending space, when the " + "DeviceCMYK colour space is used, is a device independent CMYK-based colour space or the current "
             + "PDF/A OutputIntent, when the DeviceCMYK colour space is used, contains a ‘CMYK’ destination " + "profile.";

        public const String DEVICEGRAY_SHALL_ONLY_BE_USED_IF_CURRENT_PDFA_OUTPUT_INTENT_OR_DEFAULTGRAY_IN_USAGE_CONTEXT
