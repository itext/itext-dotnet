...
namespace iText.Commons.Bouncycastle.Security {
    ...
    /// </summary>
    public class AbstractCrlException : Exception {
        /// <summary>
        /// Base constructor for <see cref="CertificateExpiredException"/>.
        /// </summary>
        protected AbstractCrlException() {
        }
        
        /// <summary>
        /// Creates new wrapper instance for <see cref="AbstractCrlException"/>.
        /// The abstract class constructor gets executed from a derived class.
        /// </summary>
        /// <param name="message">Exception message</param>
        protected AbstractCrlException(string message) : base(message) {
        }
    }
}
