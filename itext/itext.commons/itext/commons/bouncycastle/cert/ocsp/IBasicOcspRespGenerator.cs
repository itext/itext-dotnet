...
namespace iText.Commons.Bouncycastle.Cert.Ocsp {
    ...
    /// </summary>
    public interface IBasicOcspRespGenerator {
        /// <summary>
        /// Calls actual
        ...
        /// <returns>
        /// 
        /// <see cref="IBasicOcspRespGenerator"/>
        /// this wrapper object.
        /// </returns>
        ...
        /// this wrapper object.
        /// </returns>
        IBasicOcspRespGenerator AddResponse(ICertID certID, ICertStatus certificateStatus, DateTime time, DateTime
             time1, IX509Extensions extensions);
