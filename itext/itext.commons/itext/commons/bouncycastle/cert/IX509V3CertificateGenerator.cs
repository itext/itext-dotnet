...
namespace iText.Commons.Bouncycastle.Cert {
    ...
    /// </summary>
    public interface IX509V3CertificateGenerator {
        /// <summary>
        /// Calls actual
        /// <c>build</c>
        ...
        /// <returns>
        /// 
        /// <see cref="IX509V3CertificateGenerator"/>
        /// this wrapper object.
        /// </returns>
        IX509V3CertificateGenerator AddExtension(IDerObjectIdentifier extensionOID, bool critical, IAsn1Encodable
             extensionValue);
    }
}
