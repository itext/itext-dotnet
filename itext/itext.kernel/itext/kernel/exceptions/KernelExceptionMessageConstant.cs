...
namespace iText.Kernel.Exceptions {
    ...
    public sealed class KernelExceptionMessageConstant {
        ...
        public const String INVALID_METADATA_VALUE = "Document metadata value shall be a valid XMP metadata stream.";
        ...
        public const String METADATA_STREAM_REQUIRES_METADATA_TYPE_AND_XML_SUBTYPE = "Document XMP metadata stream requires /Metadata type and /XML subtype.";
        ...
        public const String XMP_METADATA_HEADER_SHALL_CONTAIN_WTPDF_ACCESSIBILITY_METADATA = "XMP metadata header shall contain declaration for Well Tagged PDF For Accessibility.";

        public const String XMP_METADATA_HEADER_SHALL_CONTAIN_WTPDF_REUSE_METADATA = "XMP metadata header shall contain declaration for Well Tagged PDF For Reuse.";
