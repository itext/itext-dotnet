...
namespace iText.Kernel.Pdf {
    /// <summary>Enforces configurable limits intended to protect PDF reading/parsing against excessive memory consumption.
    ///     </summary>
    /// <remarks>
    /// Enforces configurable limits intended to protect PDF reading/parsing against excessive memory consumption.
    /// <para />The handler is primarily used during decoding (decompression) of PDF streams, but also guards against other
    ...
    /// <para />A configured handler can be set on
...
//\endcond
        ...
        /// to handle decompression of PDF streams and other memory-related limits
        /// during reading.
        /// </summary>
