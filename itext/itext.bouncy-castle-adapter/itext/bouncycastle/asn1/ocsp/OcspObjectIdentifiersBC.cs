...
namespace iText.Bouncycastle.Asn1.Ocsp {
    ...
    public class OcspObjectIdentifiersBC : IOcspObjectIdentifiers {
        private static readonly OcspObjectIdentifiersBC INSTANCE = new OcspObjectIdentifiersBC(null);

        private static readonly IDerObjectIdentifier ID_PKIX_OCSP_BASIC = new DerObjectIdentifierBC(OcspObjectIdentifiers
            .PkixOcspBasic);

        private static readonly IDerObjectIdentifier ID_PKIX_OCSP_NONCE = new DerObjectIdentifierBC(OcspObjectIdentifiers
            .PkixOcspNonce);
