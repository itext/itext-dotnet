...
namespace iText.Bouncycastle.Asn1.X509 {
    ...
    public class KeyPurposeIDBC : Asn1EncodableBC, IKeyPurposeID {
        private static readonly KeyPurposeIDBC INSTANCE = new KeyPurposeIDBC(null);

        private static readonly KeyPurposeIDBC ID_KP_OCSP_SIGNING = new KeyPurposeIDBC(KeyPurposeID.IdKPOcspSigning
            );
