...
namespace iText.Bouncycastle.Asn1 {
    ...
    /// </summary>
    public class DerIntegerBC : Asn1ObjectBC, IDerInteger {
        /// <summary>
        ...
        /// to be wrapped
        /// </param>
        public DerIntegerBC(DerInteger i)
            : base(i) {
        }
        ...
        /// to be wrapped
        /// </param>
        public DerIntegerBC(IBigInteger i)
        ...
        public virtual IBigInteger GetValue() {
            return new BigIntegerBC(GetDerInteger().Value);
        }
