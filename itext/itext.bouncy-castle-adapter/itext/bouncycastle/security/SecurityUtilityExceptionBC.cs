...
namespace iText.Bouncycastle.Security {
    /// <summary>Wrapper class for <see cref="SecurityUtilityException"/>.</summary>
    public class SecurityUtilityExceptionBC : AbstractSecurityUtilityException {
        ...
        /// <summary>
        /// Creates new wrapper for <see cref="SecurityUtilityException"/>.
        /// </summary>
        /// <param name="exception">
        /// <see cref="SecurityUtilityException"/> to be wrapped
        /// </param>
        ...
        /// <returns>wrapped <see cref="SecurityUtilityException"/>.</returns>
