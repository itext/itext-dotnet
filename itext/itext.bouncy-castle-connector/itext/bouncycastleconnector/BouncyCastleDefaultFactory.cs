...
namespace iText.Bouncycastleconnector {
    ...
    public class BouncyCastleDefaultFactory : IBouncyCastleFactory {
        ...
        public ITimeStampTokenGenerator CreateTimeStampTokenGenerator(IPrivateKey pk, IX509Certificate cert, string signatureAlgorithm,
        ...
        public IRespID CreateRespID(IX509Certificate certificate) {
            throw new NotSupportedException(BouncyCastleLogMessageConstant.BOUNCY_CASTLE_DEPENDENCY_MUST_PRESENT);
        }
        ...
        public IExtendedKeyUsage CreateExtendedKeyUsage(IDerObjectIdentifier[] purposeId) {
            throw new NotSupportedException(BouncyCastleLogMessageConstant.BOUNCY_CASTLE_DEPENDENCY_MUST_PRESENT);
        }
