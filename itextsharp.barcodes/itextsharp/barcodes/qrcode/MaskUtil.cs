/*
$Id: eeade91ceb1420795de4262c96551d4d1ce982ac $
			...
			for (int y = 0; y < height; ++y)
			{
				for (int x = 0; x < width; ++x)
				{
					...
					if (x + 6 < width && array[y][x] == 1 && array[y][x + 1] == 0 && array[y][x + 2] 
						...
						array[y][x + 6] == 1 && ((x + 10 < width && array[y][x + 7] == 0 && array[y][x +
						 8] == 0 && array[y][x + 9] == 0 && array[y][x + 10] == 0) || (x - 4 >= 0 && array
						[y][x - 1] == 0 && array[y][x - 2] == 0 && array[y][x - 3] == 0 && array[y][x - 
						4] == 0)))
					{
						penalty += 40;
					}
					if (y + 6 < height && array[y][x] == 1 && array[y + 1][x] == 0 && array[y + 2][x]
						 ...
						 array[y + 6][x] == 1 && ((y + 10 < height && array[y + 7][x] == 0 && array[y + 
						8][x] == 0 && array[y + 9][x] == 0 && array[y + 10][x] == 0) || (y - 4 >= 0 && array
						[y - 1][x] == 0 && array[y - 2][x] == 0 && array[y - 3][x] == 0 && array[y - 4][
						x] == 0)))
					{
						penalty += 40;
					}
