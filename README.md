...
| <br>                                       |                                                                                                                                                                                                                                                                                                                        |
| **Digital signatures**                     |                                                                                                                                                                                                                                                                                                                        |
| Sign PDF document                          | [C#](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/itext/samples/sandbox/signatures/SignatureExample.cs), [PDF](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/cmpfiles/sandbox/signatures/cmp_signExample.pdf)               |
| Customize signature appearance             | [C#](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/itext/samples/sandbox/signatures/appearance), [PDFs](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/cmpfiles/sandbox/signatures/appearance)                                |
| Sign PDF document with PaDES Profile       | [C#](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/itext/samples/sandbox/signatures/pades), [PDFs](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/cmpfiles/sandbox/signatures/pades)                                          |
| Two-phase signing                          | [C#](https://github.com/itext/itext-publications-samples-dotnet/tree/master/itext/itext.samples/itext/samples/sandbox/signatures/twophase), [PDFs](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/cmpfiles/sandbox/signatures/twophase)                                    |
| Signature validation                       | [C#](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/itext/samples/sandbox/signatures/validation)                                                                                                                                                                           |
| Signing using PQC algorithms (experimental)| [C#](https://github.com/itext/itext-publications-samples-dotnet/blob/develop/itext/itext.samples/itext/samples/sandbox/signatures/pqc), [PDFs](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/cmpfiles/sandbox/signatures/pqc)                                             |
| Custom HTML tag for signature              | [C#](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/itext/samples/sandbox/signatures/signaturetag/ConvertToPdfAndSign.cs), [HTML](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/resources/signatures/signaturetag/ConvertToPdfAndSign/htmlWithSignatureTag.html), [PDF](https://github.com/itext/itext-publications-samples-dotnet/blob/master/itext/itext.samples/cmpfiles/sandbox/signatures/signaturetag/ConvertToPdfAndSign/cmp_signedPdfAfterConvert.pdf)                                                     |
| <br>                                       |                                                                                                                                                                                                                                                                                                                        |
| **FIPS**                                   |                                                                                                                                                                                                                                                                                                                        |
