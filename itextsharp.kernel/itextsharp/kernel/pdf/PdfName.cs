...
namespace iTextSharp.Kernel.Pdf
{
		...
		>
	{
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName AbsoluteColorimetric = CreateDirectName
			("AbsoluteColorimetric");

		public static readonly iTextSharp.Kernel.Pdf.PdfName AcroForm = CreateDirectName(
			"AcroForm");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Action = CreateDirectName("Action"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ActualText = CreateDirectName
			("ActualText");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ADBE = CreateDirectName("ADBE"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName Adbe_pkcs7_detached = CreateDirectName
			("adbe.pkcs7.detached");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Adbe_pkcs7_s4 = CreateDirectName
			("adbe.pkcs7.s4");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Adbe_pkcs7_s5 = CreateDirectName
			("adbe.pkcs7.s5");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Adbe_pkcs7_sha1 = CreateDirectName
			("adbe.pkcs7.sha1");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Adbe_x509_rsa_sha1 = CreateDirectName
			("adbe.x509.rsa_sha1");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Adobe_PPKLite = CreateDirectName
			("Adobe.PPKLite");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Adobe_PPKMS = CreateDirectName
			("Adobe.PPKMS");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Adobe_PubSec = CreateDirectName
			("Adobe.PubSec");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName AFRelationship = CreateDirectName
			("AFRelationship");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Alternate = CreateDirectName
			("Alternate");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Alternates = CreateDirectName
			("Alternate");

		public static readonly iTextSharp.Kernel.Pdf.PdfName AlternatePresentations = CreateDirectName
			("AlternatePresentations");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Alternative = CreateDirectName
			("Alternative");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Annotation = CreateDirectName
			("Annotation");

		public static readonly iTextSharp.Kernel.Pdf.PdfName AnnotStates = CreateDirectName
			("AnnotStates");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName AppDefault = CreateDirectName
			("AppDefault");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ApplicationOctetStream = CreateDirectName
			("application/octet-stream");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ApplicationPdf = CreateDirectName
			("application/pdf");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ApplicationXml = CreateDirectName
			("application/xml");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Approved = CreateDirectName(
			"Approved");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Artifact = CreateDirectName(
			"Artifact");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ASCII85Decode = CreateDirectName
			("ASCII85Decode");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ASCIIHexDecode = CreateDirectName
			("ASCIIHexDecode");

		public static readonly iTextSharp.Kernel.Pdf.PdfName AsIs = CreateDirectName("AsIs"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName AuthEvent = CreateDirectName
			("AuthEvent");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Author = CreateDirectName("Author"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName BackgroundColor = CreateDirectName
			("BackgroundColor");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BaseFont = CreateDirectName(
			"BaseFont");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BaseEncoding = CreateDirectName
			("BaseEncoding");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BaselineShift = CreateDirectName
			("BaselineShift");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BaseVersion = CreateDirectName
			("BaseVersion");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName BibEntry = CreateDirectName(
			"BibEntry");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BitsPerComponent = CreateDirectName
			("BitsPerComponent");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BitsPerCoordinate = CreateDirectName
			("BitsPerCoordinate");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BitsPerFlag = CreateDirectName
			("BitsPerFlag");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BitsPerSample = CreateDirectName
			("BitsPerSample");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Bl = CreateDirectName("Bl");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BlackIs1 = CreateDirectName(
			"BlackIs1");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BlackPoint = CreateDirectName
			("BlackPoint");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BleedBox = CreateDirectName(
			"BleedBox");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Block = CreateDirectName("Block"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName BlockAlign = CreateDirectName
			("BlockAlign");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BlockQuote = CreateDirectName
			("BlockQuote");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName BorderColor = CreateDirectName
			("BorderColor");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BorderStyle = CreateDirectName
			("BorderStyle");

		public static readonly iTextSharp.Kernel.Pdf.PdfName BorderThikness = CreateDirectName
			("BorderThikness");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ByteRange = CreateDirectName
			("ByteRange");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName CapHeight = CreateDirectName
			("CapHeight");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Category = CreateDirectName(
			"Category");

		public static readonly iTextSharp.Kernel.Pdf.PdfName CCITTFaxDecode = CreateDirectName
			("CCITTFaxDecode");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Center = CreateDirectName("Center"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName CenterWindow = CreateDirectName
			("CenterWindow");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName CIDFontType0 = CreateDirectName
			("CIDFontType0");

		public static readonly iTextSharp.Kernel.Pdf.PdfName CIDFontType2 = CreateDirectName
			("CIDFontType2");

		public static readonly iTextSharp.Kernel.Pdf.PdfName CIDSet = CreateDirectName("CIDSet"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName CIDSystemInfo = CreateDirectName
			("CIDSystemInfo");

		public static readonly iTextSharp.Kernel.Pdf.PdfName CIDToGIDMap = CreateDirectName
			("CIDToGIDMap");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ClosedArrow = CreateDirectName
			("ClosedArrow");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Collection = CreateDirectName
			("Collection");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ColSpan = CreateDirectName("ColSpan"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ColumnCount = CreateDirectName
			("ColumnCount");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ColumnGap = CreateDirectName
			("ColumnGap");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ColumnWidths = CreateDirectName
			("ColumnWidths");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ContactInfo = CreateDirectName
			("ContactInfo");

		public static readonly iTextSharp.Kernel.Pdf.PdfName CharProcs = CreateDirectName
			("CharProcs");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Color = CreateDirectName("Color"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ColorBurn = CreateDirectName
			("ColorBurn");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ColorDodge = CreateDirectName
			("ColorDodge");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Colorants = CreateDirectName
			("Colorants");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Colors = CreateDirectName("Colors"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ColorSpace = CreateDirectName
			("ColorSpace");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ColorTransform = CreateDirectName
			("ColorTransform");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Columns = CreateDirectName("Columns"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName Compatible = CreateDirectName
			("Compatible");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Confidential = CreateDirectName
			("Confidential");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Configs = CreateDirectName("Configs"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName Contents = CreateDirectName(
			"Contents");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName CreationDate = CreateDirectName
			("CreationDate");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Creator = CreateDirectName("Creator"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName CreatorInfo = CreateDirectName
			("CreatorInfo");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName DCTDecode = CreateDirectName
			("DCTDecode");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName DecodeParms = CreateDirectName
			("DecodeParms");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Default = CreateDirectName("Default"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName DefaultCMYK = CreateDirectName
			("DefaultCMYK");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DefaultCryptFilter = CreateDirectName
			("DefaultCryptFilter");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DefaultGray = CreateDirectName
			("DefaultGray");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DefaultRGB = CreateDirectName
			("DefaultRGB");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Departmental = CreateDirectName
			("Departmental");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DescendantFonts = CreateDirectName
			("DescendantFonts");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName DestOutputProfile = CreateDirectName
			("DestOutputProfile");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Dests = CreateDirectName("Dests"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName DeviceCMY = CreateDirectName
			("DeviceCMY");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DeviceCMYK = CreateDirectName
			("DeviceCMYK");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DeviceGray = CreateDirectName
			("DeviceGray");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DeviceN = CreateDirectName("DeviceN"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName DeviceRGB = CreateDirectName
			("DeviceRGB");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DeviceRGBK = CreateDirectName
			("DeviceRGBK");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Difference = CreateDirectName
			("Difference");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Differences = CreateDirectName
			("Differences");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Div = CreateDirectName("Div"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName DigestLocation = CreateDirectName
			("DigestLocation");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DigestMethod = CreateDirectName
			("DigestMethod");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DigestValue = CreateDirectName
			("DigestValue");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Direction = CreateDirectName
			("Direction");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DisplayDocTitle = CreateDirectName
			("DisplayDocTitle");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName DocTimeStamp = CreateDirectName
			("DocTimeStamp");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Document = CreateDirectName(
			"Document");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName DuplexFlipShortEdge = CreateDirectName
			("DuplexFlipShortEdge");

		public static readonly iTextSharp.Kernel.Pdf.PdfName DuplexFlipLongEdge = CreateDirectName
			("DuplexFlipLongEdge");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName EmbeddedFile = CreateDirectName
			("EmbeddedFile");

		public static readonly iTextSharp.Kernel.Pdf.PdfName EmbeddedFiles = CreateDirectName
			("EmbeddedFiles");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Encode = CreateDirectName("Encode"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName EncodedByteAlign = CreateDirectName
			("EncodedByteAlign");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Encoding = CreateDirectName(
			"Encoding");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Encrypt = CreateDirectName("Encrypt"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName EncryptMetadata = CreateDirectName
			("EncryptMetadata");

		public static readonly iTextSharp.Kernel.Pdf.PdfName End = CreateDirectName("End"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName EndIndent = CreateDirectName
			("EndIndent");

		public static readonly iTextSharp.Kernel.Pdf.PdfName EndOfBlock = CreateDirectName
			("EndOfBlock");

		public static readonly iTextSharp.Kernel.Pdf.PdfName EndOfLine = CreateDirectName
			("EndOfLine");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ESIC = CreateDirectName("ESIC"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ETSI_CAdES_DETACHED = CreateDirectName
			("ETSI.CAdES.detached");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ETSI_RFC3161 = CreateDirectName
			("ETSI.RFC3161");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Exclusion = CreateDirectName
			("Exclusion");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ExData = CreateDirectName("ExData"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName Experimental = CreateDirectName
			("Experimental");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ExportState = CreateDirectName
			("ExportState");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Extensions = CreateDirectName
			("Extensions");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ExtensionLevel = CreateDirectName
			("ExtensionLevel");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ExtGState = CreateDirectName
			("ExtGState");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName FieldMDP = CreateDirectName(
			"FieldMDP");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName FileAttachment = CreateDirectName
			("FileAttachment");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Filespec = CreateDirectName(
			"Filespec");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName FDecodeParams = CreateDirectName
			("FDecodeParams");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName FirstChar = CreateDirectName
			("FirstChar");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FirstPage = CreateDirectName
			("FirstPage");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName FitWindow = CreateDirectName
			("FitWindow");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FixedPrint = CreateDirectName
			("FixedPrint");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName FlateDecode = CreateDirectName
			("FlateDecode");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName FontBBox = CreateDirectName(
			"FontBBox");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontDescriptor = CreateDirectName
			("FontDescriptor");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontFamily = CreateDirectName
			("FontFamily");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontFauxing = CreateDirectName
			("FontFauxing");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontFile = CreateDirectName(
			"FontFile");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontFile2 = CreateDirectName
			("FontFile2");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontFile3 = CreateDirectName
			("FontFile3");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontMatrix = CreateDirectName
			("FontMatrix");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontName = CreateDirectName(
			"FontName");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontWeight = CreateDirectName
			("FontWeight");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FontStretch = CreateDirectName
			("FontStretch");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ForComment = CreateDirectName
			("ForComment");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Form = CreateDirectName("Form"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ForPublicRelease = CreateDirectName
			("ForPublicRelease");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FormType = CreateDirectName(
			"FormType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FreeText = CreateDirectName(
			"FreeText");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FreeTextCallout = CreateDirectName
			("FreeTextCallout");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FreeTextTypeWriter = CreateDirectName
			("FreeTextTypeWriter");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName FullScreen = CreateDirectName
			("FullScreen");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Function = CreateDirectName(
			"Function");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Functions = CreateDirectName
			("Functions");

		public static readonly iTextSharp.Kernel.Pdf.PdfName FunctionType = CreateDirectName
			("FunctionType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Gamma = CreateDirectName("Gamma"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName GlyphOrientationVertical = CreateDirectName
			("GlyphOrientationVertical");

		public static readonly iTextSharp.Kernel.Pdf.PdfName GoTo = CreateDirectName("GoTo"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName GoTo3DView = CreateDirectName
			("GoTo3DView");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName GTS_PDFA1 = CreateDirectName
			("GTS_PDFA1");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName HalftoneType = CreateDirectName
			("HalftoneType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName HalftoneName = CreateDirectName
			("HalftoneName");

		public static readonly iTextSharp.Kernel.Pdf.PdfName HardLight = CreateDirectName
			("HardLight");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName HideMenubar = CreateDirectName
			("HideMenubar");

		public static readonly iTextSharp.Kernel.Pdf.PdfName HideToolbar = CreateDirectName
			("HideToolbar");

		public static readonly iTextSharp.Kernel.Pdf.PdfName HideWindowUI = CreateDirectName
			("HideWindowUI");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Highlight = CreateDirectName
			("Highlight");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ICCBased = CreateDirectName(
			"ICCBased");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ID = CreateDirectName("ID");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Identity = CreateDirectName(
			"Identity");

		public static readonly iTextSharp.Kernel.Pdf.PdfName IdentityH = CreateDirectName
			("Identity-H");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ImageMask = CreateDirectName
			("ImageMask");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ImportData = CreateDirectName
			("ImportData");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName InlineAlign = CreateDirectName
			("InlineAlign");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Interpolate = CreateDirectName
			("Interpolate");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ItalicAngle = CreateDirectName
			("ItalicAngle");

		public static readonly iTextSharp.Kernel.Pdf.PdfName IT = CreateDirectName("IT");

		public static readonly iTextSharp.Kernel.Pdf.PdfName JavaScript = CreateDirectName
			("JavaScript");

		public static readonly iTextSharp.Kernel.Pdf.PdfName JBIG2Decode = CreateDirectName
			("JBIG2Decode");

		public static readonly iTextSharp.Kernel.Pdf.PdfName JBIG2Globals = CreateDirectName
			("JBIG2Globals");

		public static readonly iTextSharp.Kernel.Pdf.PdfName JPXDecode = CreateDirectName
			("JPXDecode");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Keywords = CreateDirectName(
			"Keywords");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Language = CreateDirectName(
			"Language");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Last = CreateDirectName("Last"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName LastChar = CreateDirectName(
			"LastChar");

		public static readonly iTextSharp.Kernel.Pdf.PdfName LastModified = CreateDirectName
			("LastModified");

		public static readonly iTextSharp.Kernel.Pdf.PdfName LastPage = CreateDirectName(
			"LastPage");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName LineHeight = CreateDirectName
			("LineHeight");

		public static readonly iTextSharp.Kernel.Pdf.PdfName LineThrough = CreateDirectName
			("LineThrough");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ListMode = CreateDirectName(
			"ListMode");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ListNumbering = CreateDirectName
			("ListNumbering");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Location = CreateDirectName(
			"Location");

		public static readonly iTextSharp.Kernel.Pdf.PdfName LowerAlpha = CreateDirectName
			("LowerAlpha");

		public static readonly iTextSharp.Kernel.Pdf.PdfName LowerRoman = CreateDirectName
			("LowerRoman");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Luminosity = CreateDirectName
			("Luminosity");

		public static readonly iTextSharp.Kernel.Pdf.PdfName LW = CreateDirectName("LW");

		public static readonly iTextSharp.Kernel.Pdf.PdfName LZWDecode = CreateDirectName
			("LZWDecode");

		public static readonly iTextSharp.Kernel.Pdf.PdfName M = CreateDirectName("M");

		public static readonly iTextSharp.Kernel.Pdf.PdfName MacExpertEncoding = CreateDirectName
			("MacExpertEncoding");

		public static readonly iTextSharp.Kernel.Pdf.PdfName MacRomanEncoding = CreateDirectName
			("MacRomanEncoding");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Marked = CreateDirectName("Marked"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName MarkInfo = CreateDirectName(
			"MarkInfo");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Markup = CreateDirectName("Markup"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName MarkStyle = CreateDirectName
			("MarkStyle");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName MediaBox = CreateDirectName(
			"MediaBox");

		public static readonly iTextSharp.Kernel.Pdf.PdfName MediaClip = CreateDirectName
			("MediaClip");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Metadata = CreateDirectName(
			"Metadata");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName MissingWidth = CreateDirectName
			("MissingWidth");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Multiply = CreateDirectName(
			"Multiply");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName NeedAppearances = CreateDirectName
			("NeedAppearances");

		public static readonly iTextSharp.Kernel.Pdf.PdfName NeedsRendering = CreateDirectName
			("NeedsRendering");

		public static readonly iTextSharp.Kernel.Pdf.PdfName NewWindow = CreateDirectName
			("NewWindow");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Next = CreateDirectName("Next"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName NextPage = CreateDirectName(
			"NextPage");

		public static readonly iTextSharp.Kernel.Pdf.PdfName NM = CreateDirectName("NM");

		public static readonly iTextSharp.Kernel.Pdf.PdfName NonFullScreenPageMode = CreateDirectName
			("NonFullScreenPageMode");

		public static readonly iTextSharp.Kernel.Pdf.PdfName None = CreateDirectName("None"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName NonStruct = CreateDirectName
			("NonStruct");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName NotApproved = CreateDirectName
			("NotApproved");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Note = CreateDirectName("Note"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName NotForPublicRelease = CreateDirectName
			("NotForPublicRelease");

		public static readonly iTextSharp.Kernel.Pdf.PdfName NumCopies = CreateDirectName
			("NumCopies");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName OCProperties = CreateDirectName
			("OCProperties");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName OneColumn = CreateDirectName
			("OneColumn");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName OpenAction = CreateDirectName
			("OpenAction");

		public static readonly iTextSharp.Kernel.Pdf.PdfName OpenArrow = CreateDirectName
			("OpenArrow");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Operation = CreateDirectName
			("Operation");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Ordering = CreateDirectName(
			"Ordering");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Outlines = CreateDirectName(
			"Outlines");

		public static readonly iTextSharp.Kernel.Pdf.PdfName OutputCondition = CreateDirectName
			("OutputCondition");

		public static readonly iTextSharp.Kernel.Pdf.PdfName OutputConditionIdentifier = 
			CreateDirectName("OutputConditionIdentifier");

		public static readonly iTextSharp.Kernel.Pdf.PdfName OutputIntent = CreateDirectName
			("OutputIntent");

		public static readonly iTextSharp.Kernel.Pdf.PdfName OutputIntents = CreateDirectName
			("OutputIntents");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName OverlayText = CreateDirectName
			("OverlayText");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName PageElement = CreateDirectName
			("PageElement");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PageLabels = CreateDirectName
			("PageLabels");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PageLayout = CreateDirectName
			("PageLayout");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PageMode = CreateDirectName(
			"PageMode");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Pages = CreateDirectName("Pages"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName PaintType = CreateDirectName
			("PaintType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Panose = CreateDirectName("Panose"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName Paperclip = CreateDirectName
			("Paperclip");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ParentTree = CreateDirectName
			("ParentTree");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ParentTreeNextKey = CreateDirectName
			("ParentTreeNextKey");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName PatternType = CreateDirectName
			("PatternType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Perceptual = CreateDirectName
			("Perceptual");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Pdf_Version_1_2 = CreateDirectName
			("1.2");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Pdf_Version_1_3 = CreateDirectName
			("1.3");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Pdf_Version_1_4 = CreateDirectName
			("1.4");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Pdf_Version_1_5 = CreateDirectName
			("1.5");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Pdf_Version_1_6 = CreateDirectName
			("1.6");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Pdf_Version_1_7 = CreateDirectName
			("1.7");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Pg = CreateDirectName("Pg");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PickTrayByPDFSize = CreateDirectName
			("PickTrayByPDFSize");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Placement = CreateDirectName
			("Placement");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Polygon = CreateDirectName("Polygon"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName PolyLine = CreateDirectName(
			"PolyLine");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Popup = CreateDirectName("Popup"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName Predictor = CreateDirectName
			("Predictor");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Preferred = CreateDirectName
			("Preferred");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PreserveRB = CreateDirectName
			("PreserveRB");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PresSteps = CreateDirectName
			("PresSteps");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Prev = CreateDirectName("Prev"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName PrevPage = CreateDirectName(
			"PrevPage");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Print = CreateDirectName("Print"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName PrintArea = CreateDirectName
			("PrintArea");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PrintClip = CreateDirectName
			("PrintClip");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PrinterMark = CreateDirectName
			("PrinterMark");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PrintPageRange = CreateDirectName
			("PrintPageRange");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PrintScaling = CreateDirectName
			("PrintScaling");

		public static readonly iTextSharp.Kernel.Pdf.PdfName PrintState = CreateDirectName
			("PrintState");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Producer = CreateDirectName(
			"Producer");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Prop_Build = CreateDirectName
			("Prop_Build");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Properties = CreateDirectName
			("Properties");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName QuadPoints = CreateDirectName
			("QuadPoints");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName RBGroups = CreateDirectName(
			"RBGroups");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Recipients = CreateDirectName
			("Recipients");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Reference = CreateDirectName
			("Reference");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Registry = CreateDirectName(
			"Registry");

		public static readonly iTextSharp.Kernel.Pdf.PdfName RegistryName = CreateDirectName
			("RegistryName");

		public static readonly iTextSharp.Kernel.Pdf.PdfName RelativeColorimetric = CreateDirectName
			("RelativeColorimetric");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Rendition = CreateDirectName
			("Rendition");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Repeat = CreateDirectName("Repeat"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ResetForm = CreateDirectName
			("ResetForm");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Requirements = CreateDirectName
			("Requirements");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Resources = CreateDirectName
			("Resources");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ReversedChars = CreateDirectName
			("ReversedChars");

		public static readonly iTextSharp.Kernel.Pdf.PdfName RI = CreateDirectName("RI");

		public static readonly iTextSharp.Kernel.Pdf.PdfName RichMedia = CreateDirectName
			("RichMedia");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName RubyAlign = CreateDirectName
			("RubyAlign");

		public static readonly iTextSharp.Kernel.Pdf.PdfName RubyPosition = CreateDirectName
			("RubyPosition");

		public static readonly iTextSharp.Kernel.Pdf.PdfName RunLengthDecode = CreateDirectName
			("RunLengthDecode");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Saturation = CreateDirectName
			("Saturation");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Separation = CreateDirectName
			("Separation");

		public static readonly iTextSharp.Kernel.Pdf.PdfName SeparationColorNames = CreateDirectName
			("SeparationColorNames");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Shading = CreateDirectName("Shading"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ShadingType = CreateDirectName
			("ShadingType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName SetOCGState = CreateDirectName
			("SetOCGState");

		public static readonly iTextSharp.Kernel.Pdf.PdfName SetState = CreateDirectName(
			"SetState");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Sig = CreateDirectName("Sig"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName SigFieldLock = CreateDirectName
			("SigFieldLock");

		public static readonly iTextSharp.Kernel.Pdf.PdfName SigFlags = CreateDirectName(
			"SigFlags");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName SinglePage = CreateDirectName
			("SinglePage");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName SMaskInData = CreateDirectName
			("SMaskInData");

		public static readonly iTextSharp.Kernel.Pdf.PdfName SoftLight = CreateDirectName
			("SoftLight");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName SpaceBefore = CreateDirectName
			("SpaceBefore");

		public static readonly iTextSharp.Kernel.Pdf.PdfName SpaceAfter = CreateDirectName
			("SpaceAfter");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Square = CreateDirectName("Square"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName Squiggly = CreateDirectName(
			"Squiggly");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Standard = CreateDirectName(
			"Standard");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Start = CreateDirectName("Start"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName StartIndent = CreateDirectName
			("StartIndent");

		public static readonly iTextSharp.Kernel.Pdf.PdfName State = CreateDirectName("State"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName StateModel = CreateDirectName
			("StateModel");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName StrikeOut = CreateDirectName
			("StrikeOut");

		public static readonly iTextSharp.Kernel.Pdf.PdfName StructElem = CreateDirectName
			("StructElem");

		public static readonly iTextSharp.Kernel.Pdf.PdfName StructParent = CreateDirectName
			("StructParent");

		public static readonly iTextSharp.Kernel.Pdf.PdfName StructParents = CreateDirectName
			("StructParents");

		public static readonly iTextSharp.Kernel.Pdf.PdfName StructTreeRoot = CreateDirectName
			("StructTreeRoot");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Style = CreateDirectName("Style"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName SubFilter = CreateDirectName
			("SubFilter");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName SubmitForm = CreateDirectName
			("SubmitForm");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Subtype = CreateDirectName("Subtype"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName Subtype2 = CreateDirectName(
			"Subtype2");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Supplement = CreateDirectName
			("Supplement");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Sy = CreateDirectName("Sy");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Symbol = new iTextSharp.Kernel.Pdf.PdfName
			("Symbol");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Synchronous = CreateDirectName
			("Synchronous");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName TBorderStyle = CreateDirectName
			("TBorderStyle");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName TextAlign = CreateDirectName
			("TextAlign");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TextDecorationColor = CreateDirectName
			("TextDecorationColor");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TextDecorationThickness = CreateDirectName
			("TextDecorationThickness");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TextDecorationType = CreateDirectName
			("TextDecorationType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TextIndent = CreateDirectName
			("TextIndent");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName TilingType = CreateDirectName
			("TilingType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Title = CreateDirectName("Title"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName TPadding = CreateDirectName(
			"TPadding");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName TopSecret = CreateDirectName
			("TopSecret");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ToUnicode = CreateDirectName
			("ToUnicode");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName TransformMethod = CreateDirectName
			("TransformMethod");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TransformParams = CreateDirectName
			("TransformParams");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Transparency = CreateDirectName
			("Transparency");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TrapNet = CreateDirectName("TrapNet"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName TrapRegions = CreateDirectName
			("TrapRegions");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TrapStyles = CreateDirectName
			("TrapStyles");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TrueType = CreateDirectName(
			"TrueType");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TU = CreateDirectName("TU");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TwoColumnLeft = CreateDirectName
			("TwoColumnLeft");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TwoColumnRight = CreateDirectName
			("TwoColumnRight");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TwoPageLeft = CreateDirectName
			("TwoPageLeft");

		public static readonly iTextSharp.Kernel.Pdf.PdfName TwoPageRight = CreateDirectName
			("TwoPageRight");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Underline = CreateDirectName
			("Underline");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Unspecified = CreateDirectName
			("Unspecified");

		public static readonly iTextSharp.Kernel.Pdf.PdfName UpperAlpha = CreateDirectName
			("UpperAlpha");

		public static readonly iTextSharp.Kernel.Pdf.PdfName UpperRoman = CreateDirectName
			("UpperRoman");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName UseAttachments = CreateDirectName
			("UseAttachments");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName UseOutlines = CreateDirectName
			("UseOutlines");

		public static readonly iTextSharp.Kernel.Pdf.PdfName UseThumbs = CreateDirectName
			("UseThumbs");

		public static readonly iTextSharp.Kernel.Pdf.PdfName User = CreateDirectName("User"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName UserProperties = CreateDirectName
			("UserProperties");

		public static readonly iTextSharp.Kernel.Pdf.PdfName UserUnit = CreateDirectName(
			"UserUnit");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Vertices = CreateDirectName(
			"Vertices");

		public static readonly iTextSharp.Kernel.Pdf.PdfName VerticesPerRow = CreateDirectName
			("VerticesPerRow");

		public static readonly iTextSharp.Kernel.Pdf.PdfName View = CreateDirectName("View"
			);

		public static readonly iTextSharp.Kernel.Pdf.PdfName ViewArea = CreateDirectName(
			"ViewArea");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ViewerPreferences = CreateDirectName
			("ViewerPreferences");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ViewClip = CreateDirectName(
			"ViewClip");

		public static readonly iTextSharp.Kernel.Pdf.PdfName ViewState = CreateDirectName
			("ViewState");

		public static readonly iTextSharp.Kernel.Pdf.PdfName VisiblePages = CreateDirectName
			("VisiblePages");

		public static readonly iTextSharp.Kernel.Pdf.PdfName Volatile = CreateDirectName(
			"Volatile");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName Watermark = CreateDirectName
			("Watermark");

		public static readonly iTextSharp.Kernel.Pdf.PdfName WhitePoint = CreateDirectName
			("WhitePoint");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName WinAnsiEncoding = CreateDirectName
			("WinAnsiEncoding");

		public static readonly iTextSharp.Kernel.Pdf.PdfName WritingMode = CreateDirectName
			("WritingMode");
		...
		public static readonly iTextSharp.Kernel.Pdf.PdfName ZapfDingbats = new iTextSharp.Kernel.Pdf.PdfName
			("ZapfDingbats");
		...
		static PdfName()
		{
			...
			//  '/'
			//  '#'
			Field[] fields = typeof(iTextSharp.Kernel.Pdf.PdfName).GetDeclaredFields();
			...
			try
			{
				foreach (Field field in fields)
				{
					...
					{
						iTextSharp.Kernel.Pdf.PdfName name = (iTextSharp.Kernel.Pdf.PdfName)field.Get(null
							);
