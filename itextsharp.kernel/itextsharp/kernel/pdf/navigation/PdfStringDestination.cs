/*
$Id: 3a82858a0d968694047e80760c7821d6a51fcb17 $
...
namespace iTextSharp.Kernel.Pdf.Navigation
{
	...
	{
		private const long serialVersionUID = -5949596673571485743L;
		...
		{
			PdfArray array = (PdfArray)names[((PdfString)GetPdfObject()).ToUnicodeString()];
