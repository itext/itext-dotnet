/*
$Id: bbce4ebecf364711aa9ec0f074453a65e7a8e685 $
...
namespace com.itextpdf.kernel.pdf.function
{
	public class PdfFunction : PdfObjectWrapper<PdfObject>
	{
		...
		public class Type0 : PdfFunction
		{
			...
			private static PdfStream MakeType0(PdfArray domain, PdfArray range, PdfArray size
				, PdfNumber bitsPerSample, PdfNumber order, PdfArray encode, PdfArray decode, byte
				[] samples)
			{
