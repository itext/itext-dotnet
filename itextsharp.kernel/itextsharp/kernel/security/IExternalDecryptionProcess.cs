/*
$Id: caf7560e3c7667d577b5f19db874bba013b0805c $
...
namespace iTextSharp.Kernel.Security
{
	...
	{
		/// <summary>Returns the ID of the CMS recipient.</summary>
		/// <returns>ID of the CMS Recipient</returns>
		RecipientId GetCmsRecipientId();

		/// <summary>Returns the CMS recipient</summary>
		/// <returns>CMS Recipient</returns>
